...
- Fix `NullPointerException` for missing required list, map and primitive properties when `ApiTypeHelper.DANGEROUS_disableRequiredPropertiesCheck` is enabled, e.g. `hits.hits` pruned by `filter_path` ([#2149](https://github.com/opensearch-project/opensearch-java/pull/2149))
