...
- Bump `org.owasp.dependencycheck` from 12.0.2 to 12.1.1 ([#1440](https://github.com/opensearch-project/opensearch-java/pull/1440), [#1515](https://github.com/opensearch-project/opensearch-java/pull/1515))
