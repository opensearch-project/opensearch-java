...
- Make `HitsMetadata.hits` optional so responses that omit `hits.hits` (empty results or `filter_path`) deserialize instead of throwing ([#2149](https://github.com/opensearch-project/opensearch-java/pull/2149))
