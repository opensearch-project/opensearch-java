...
public final class Collector implements ToJsonp {
	...
	@Nullable
	private final List<org.opensearch.clients.opensearch._global.search.Collector> children;
	 ...
	 */
	@Nullable
	public List<org.opensearch.clients.opensearch._global.search.Collector> children() {
	...
	protected void toJsonpInternal(JsonGenerator generator, JsonpMapper mapper) {
		...
		if (this.children != null) {
			...
			for (org.opensearch.clients.opensearch._global.search.Collector item0 : this.children) {
	...
	public static class Builder implements ObjectBuilder<Collector> {
		...
		@Nullable
		private List<org.opensearch.clients.opensearch._global.search.Collector> children;
		 ...
		 * API name: {@code children}
		 */
		public Builder children(@Nullable List<org.opensearch.clients.opensearch._global.search.Collector> value) {
			this.children = value;
			return this;
		}
		 ...
		 * API name: {@code children}
		 */
		public Builder children(org.opensearch.clients.opensearch._global.search.Collector... value) {
		 ...
		 */
		public Builder addChildren(org.opensearch.clients.opensearch._global.search.Collector value) {
			if (this.children == null) {
		...
		public Builder children(
				Function<org.opensearch.clients.opensearch._global.search.Collector.Builder,
					ObjectBuilder<org.opensearch.clients.opensearch._global.search.Collector>> fn) {
			return this.children(
					fn.apply(new org.opensearch.clients.opensearch._global.search.Collector.Builder()).build());
		}
	...
	protected static void setupCollectorDeserializer(DelegatingDeserializer<Collector.Builder> op) {
		...
		op.add(Builder::children, JsonpDeserializer
				.arrayDeserializer(org.opensearch.clients.opensearch._global.search.Collector.DESERIALIZER), "children");
