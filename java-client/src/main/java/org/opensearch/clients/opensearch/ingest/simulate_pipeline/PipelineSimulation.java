...
package org.opensearch.clients.opensearch.ingest.simulate_pipeline;
...
public final class PipelineSimulation implements ToJsonp {
	...
	@Nullable
	private final List<org.opensearch.clients.opensearch.ingest.simulate_pipeline.PipelineSimulation> processorResults;
	 ...
	 */
	@Nullable
	public List<org.opensearch.clients.opensearch.ingest.simulate_pipeline.PipelineSimulation> processorResults() {
	...
	protected void toJsonpInternal(JsonGenerator generator, JsonpMapper mapper) {
		...
		if (this.processorResults != null) {
			...
			for (org.opensearch.clients.opensearch.ingest.simulate_pipeline.PipelineSimulation item0 : this.processorResults) {
	...
	public static class Builder implements ObjectBuilder<PipelineSimulation> {
		...
		@Nullable
		private List<org.opensearch.clients.opensearch.ingest.simulate_pipeline.PipelineSimulation> processorResults;
		...
		public Builder processorResults(
				@Nullable List<org.opensearch.clients.opensearch.ingest.simulate_pipeline.PipelineSimulation> value) {
		 ...
		 */
		public Builder processorResults(
				org.opensearch.clients.opensearch.ingest.simulate_pipeline.PipelineSimulation... value) {
		 ...
		 */
		public Builder processorResults(
				Function<org.opensearch.clients.opensearch.ingest.simulate_pipeline.PipelineSimulation.Builder,
					ObjectBuilder<org.opensearch.clients.opensearch.ingest.simulate_pipeline.PipelineSimulation>> fn) {
			return this.processorResults(
					fn.apply(new org.opensearch.clients.opensearch.ingest.simulate_pipeline.PipelineSimulation.Builder())
							.build());
		}
	...
	protected static void setupPipelineSimulationDeserializer(DelegatingDeserializer<PipelineSimulation.Builder> op) {
		...
		op.add(Builder::processorResults,
				JsonpDeserializer.arrayDeserializer(
						org.opensearch.clients.opensearch.ingest.simulate_pipeline.PipelineSimulation.DESERIALIZER),
				"processor_results");
