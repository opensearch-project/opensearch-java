...
public final class SearchStats implements ToJsonp {
	...
	@Nullable
	private final Map<String, org.opensearch.clients.opensearch._types.SearchStats> groups;
	 ...
	 */
	@Nullable
	public Map<String, org.opensearch.clients.opensearch._types.SearchStats> groups() {
		return this.groups;
	}
	...
	protected void toJsonpInternal(JsonGenerator generator, JsonpMapper mapper) {
		...
		if (this.groups != null) {
			...
			generator.writeStartObject();
			for (Map.Entry<String, org.opensearch.clients.opensearch._types.SearchStats> item0 : this.groups
					.entrySet()) {
	...
	public static class Builder implements ObjectBuilder<SearchStats> {
		...
		@Nullable
		private Map<String, org.opensearch.clients.opensearch._types.SearchStats> groups;
		 ...
		 * API name: {@code groups}
		 */
		public Builder groups(@Nullable Map<String, org.opensearch.clients.opensearch._types.SearchStats> value) {
			this.groups = value;
			return this;
		}
		 ...
		 */
		public Builder putGroups(String key, org.opensearch.clients.opensearch._types.SearchStats value) {
			if (this.groups == null) {
		...
		public Builder groups(String key,
				Function<org.opensearch.clients.opensearch._types.SearchStats.Builder,
					ObjectBuilder<org.opensearch.clients.opensearch._types.SearchStats>> fn) {
			return this.groups(Collections.singletonMap(key,
					fn.apply(new org.opensearch.clients.opensearch._types.SearchStats.Builder()).build()));
		}
	...
	protected static void setupSearchStatsDeserializer(DelegatingDeserializer<SearchStats.Builder> op) {
		...
		op.add(Builder::groups, JsonpDeserializer
				.stringMapDeserializer(org.opensearch.clients.opensearch._types.SearchStats.DESERIALIZER), "groups");
