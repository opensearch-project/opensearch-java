...
import org.opensearch.clients.opensearch._global.scripts_painless_execute.PainlessExecutionPosition;
...
public class ErrorCause implements ToJsonp {
	...
	@Nullable
	private final org.opensearch.clients.opensearch._types.ErrorCause causedBy;
	...
	@Nullable
	private final List<org.opensearch.clients.opensearch._types.ErrorCause> rootCause;
	 ...
	 */
	@Nullable
	public org.opensearch.clients.opensearch._types.ErrorCause causedBy() {
	 ...
	 */
	@Nullable
	public List<org.opensearch.clients.opensearch._types.ErrorCause> rootCause() {
	...
	protected void toJsonpInternal(JsonGenerator generator, JsonpMapper mapper) {
		...
		if (this.rootCause != null) {
			...
			for (org.opensearch.clients.opensearch._types.ErrorCause item0 : this.rootCause) {
	...
	protected abstract static class AbstractBuilder<BuilderT extends AbstractBuilder<BuilderT>> {
		...
		@Nullable
		private org.opensearch.clients.opensearch._types.ErrorCause causedBy;
		...
		@Nullable
		private List<org.opensearch.clients.opensearch._types.ErrorCause> rootCause;
		 ...
		 * API name: {@code caused_by}
		 */
		public BuilderT causedBy(@Nullable org.opensearch.clients.opensearch._types.ErrorCause value) {
			this.causedBy = value;
			return self();
		}
		...
		public BuilderT causedBy(
				Function<org.opensearch.clients.opensearch._types.ErrorCause.Builder,
					ObjectBuilder<org.opensearch.clients.opensearch._types.ErrorCause>> fn) {
			return this.causedBy(fn.apply(new org.opensearch.clients.opensearch._types.ErrorCause.Builder()).build());
		}
		 ...
		 * API name: {@code root_cause}
		 */
		public BuilderT rootCause(@Nullable List<org.opensearch.clients.opensearch._types.ErrorCause> value) {
		 ...
		 * API name: {@code root_cause}
		 */
		public BuilderT rootCause(org.opensearch.clients.opensearch._types.ErrorCause... value) {
		 ...
		 */
		public BuilderT addRootCause(org.opensearch.clients.opensearch._types.ErrorCause value) {
			if (this.rootCause == null) {
		...
		public BuilderT rootCause(
				Function<org.opensearch.clients.opensearch._types.ErrorCause.Builder,
					ObjectBuilder<org.opensearch.clients.opensearch._types.ErrorCause>> fn) {
			return this.rootCause(fn.apply(new org.opensearch.clients.opensearch._types.ErrorCause.Builder()).build());
		}
		...
		public BuilderT addRootCause(
				Function<org.opensearch.clients.opensearch._types.ErrorCause.Builder,
					ObjectBuilder<org.opensearch.clients.opensearch._types.ErrorCause>> fn) {
			return this
					.addRootCause(fn.apply(new org.opensearch.clients.opensearch._types.ErrorCause.Builder()).build());
		}
	...
	protected static <BuilderT extends AbstractBuilder<BuilderT>> void setupErrorCauseDeserializer(
		...
		op.add(AbstractBuilder::causedBy, org.opensearch.clients.opensearch._types.ErrorCause.DESERIALIZER, "caused_by");
		...
		op.add(AbstractBuilder::rootCause,
				JsonpDeserializer.arrayDeserializer(org.opensearch.clients.opensearch._types.ErrorCause.DESERIALIZER),
				"root_cause");
