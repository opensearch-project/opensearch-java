...
import org.opensearch.clients.opensearch.indices.get_mapping.IndexMappingRecord;
...
public class GetMappingResponse extends DictionaryResponse<String, IndexMappingRecord> {
	...
	protected static void setupGetMappingResponseDeserializer(DelegatingDeserializer<Builder> op) {
