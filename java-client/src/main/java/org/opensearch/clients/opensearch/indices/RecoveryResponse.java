...
import org.opensearch.clients.opensearch.indices.recovery.RecoveryStatus;
...
public class RecoveryResponse extends DictionaryResponse<String, RecoveryStatus> {
	...
	protected static void setupRecoveryResponseDeserializer(DelegatingDeserializer<Builder> op) {
