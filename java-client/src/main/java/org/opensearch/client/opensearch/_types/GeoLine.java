 ...
 */
@JsonpDeserializable
public class GeoLine implements PlainJsonSerializable {
     ...
     */
    public static final JsonpDeserializer<GeoLine> _DESERIALIZER = ObjectBuilderDeserializer.lazy(
        Builder::new,
    ...
    protected static void setupGeoLineDeserializer(ObjectDeserializer<GeoLine.Builder> op) {
        ...
        op.add(
            Builder::coordinates,
            JsonpDeserializer.arrayDeserializer(JsonpDeserializer.arrayDeserializer(JsonpDeserializer.doubleDeserializer())),
            "coordinates"
        );
