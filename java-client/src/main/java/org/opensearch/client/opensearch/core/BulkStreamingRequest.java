...
import org.opensearch.client.transport.endpoints.SimpleStreamingEndpoint;
...
public class BulkStreamingRequest extends RequestBase implements Publisher<NdJsonpSerializable> {
    @Nullable
    ...
    private final Publisher<BulkOperation> operations;

    @Nullable
    private final Integer batchSize;

    @Nullable
    private final Time batchInterval;

    // ---------------------------------------------------------------------------------------------

    private BulkStreamingRequest(Builder builder) {
    ...
    public static BulkStreamingRequest of(Function<Builder, ObjectBuilder<BulkStreamingRequest>> fn) {
        return fn.apply(new Builder()).build();
    }

    @Override
    public void subscribe(Subscriber<? super NdJsonpSerializable> s) {
        operations.subscribe(s);
    }
    ...
    /**
     * Builder for {@link BulkStreamingRequest}.
     */

    public static class Builder extends ObjectBuilderBase implements ObjectBuilder<BulkStreamingRequest> {
        @Nullable
        ...
        private Publisher<BulkOperation> operations;

        @Nullable
        private Integer batchSize;

        @Nullable
        private Time batchInterval;
         ...
         */
        public final Builder operations(Publisher<BulkOperation> operations) {
        ...
        public final Builder operations(BulkOperation value, BulkOperation... values) {
            this.operations = Flux.concat(Mono.just(value), Flux.fromArray(values));
            return this;
        }
         ...
         * <p>
         * API name: {@code batchInterval}
         */
        public final Builder batchInterval(@Nullable Time value) {
         ...
         * API name: {@code batchInterval}
         */
        public final Builder batchInterval(Function<Time.Builder, ObjectBuilder<Time>> fn) {
            return this.batchInterval(fn.apply(new Time.Builder()).build());
        }

        /**
         * Builds a {@link BulkStreamingRequest}.
         *
         * @throws NullPointerException
         *             if some of the required fields are null.
         */
        public BulkStreamingRequest build() {
            _checkSingleUse();

            return new BulkStreamingRequest(this);
        }
    }
     ...
     * Endpoint "{@code bulk}".
     */
    public static final Endpoint<BulkStreamingRequest, BulkStreamingResponse, ErrorResponse> _ENDPOINT = new SimpleStreamingEndpoint<>(
        ...
        request -> {
            ...
            if (request.batchSize != null) {
                params.put("batch_size", Integer.toString(request.batchSize));
            }
            if (request.batchInterval != null) {
                params.put("batch_interval", request.batchInterval._toJsonString());
            }
            return params;
        ...
        true,
        BulkResponse._DESERIALIZER,
        (publisher, deserializer) -> {
            return new BulkStreamingResponse.Builder().items(Flux.from(publisher).map(bb -> (BulkResponse) deserializer.apply(bb))).build();
        }
    );
}
