...
public final class Info implements ToJsonp {
	...
	@Nullable
	private final List<org.opensearch.client.opensearch.task.Info> children;
	 ...
	 */
	@Nullable
	public List<org.opensearch.client.opensearch.task.Info> children() {
	...
	protected void toJsonpInternal(JsonGenerator generator, JsonpMapper mapper) {
		...
		if (this.children != null) {
			...
			for (org.opensearch.client.opensearch.task.Info item0 : this.children) {
	...
	public static class Builder implements ObjectBuilder<Info> {
		...
		@Nullable
		private List<org.opensearch.client.opensearch.task.Info> children;
		 ...
		 * API name: {@code children}
		 */
		public Builder children(@Nullable List<org.opensearch.client.opensearch.task.Info> value) {
			this.children = value;
			return this;
		}
		 ...
		 * API name: {@code children}
		 */
		public Builder children(org.opensearch.client.opensearch.task.Info... value) {
		 ...
		 */
		public Builder addChildren(org.opensearch.client.opensearch.task.Info value) {
			if (this.children == null) {
		...
		public Builder children(
				Function<org.opensearch.client.opensearch.task.Info.Builder,
					ObjectBuilder<org.opensearch.client.opensearch.task.Info>> fn) {
			return this.children(fn.apply(new org.opensearch.client.opensearch.task.Info.Builder()).build());
		}
		...
		public Builder addChildren(
				Function<org.opensearch.client.opensearch.task.Info.Builder,
					ObjectBuilder<org.opensearch.client.opensearch.task.Info>> fn) {
			return this.addChildren(fn.apply(new org.opensearch.client.opensearch.task.Info.Builder()).build());
		}
	...
	protected static void setupInfoDeserializer(DelegatingDeserializer<Info.Builder> op) {
		...
		op.add(Builder::children,
				JsonpDeserializer.arrayDeserializer(org.opensearch.client.opensearch.task.Info.DESERIALIZER),
				"children");
