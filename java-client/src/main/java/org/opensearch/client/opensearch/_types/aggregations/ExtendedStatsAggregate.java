...
public class ExtendedStatsAggregate extends StatsAggregate implements AggregateVariant {
    ...
    public static class Builder extends ExtendedStatsAggregate.AbstractBuilder<Builder> implements ObjectBuilder<ExtendedStatsAggregate> {
        @Override
    ...
    protected abstract static class AbstractBuilder<BuilderT extends AbstractBuilder<BuilderT>> extends StatsAggregate.AbstractBuilder<
        BuilderT> {
    ...
    protected static <BuilderT extends AbstractBuilder<BuilderT>> void setupExtendedStatsAggregateDeserializer(
        ...
        op.add(AbstractBuilder::variancePopulation, JsonpDeserializer.doubleOrNullDeserializer(0), "variance_population");
