...
public class PainlessContextSetup implements PlainJsonSerializable {
     ...
     */
    public static final JsonpDeserializer<PainlessContextSetup> _DESERIALIZER = ObjectBuilderDeserializer.lazy(
        Builder::new,
        PainlessContextSetup::setupPainlessContextSetupDeserializer
    );
