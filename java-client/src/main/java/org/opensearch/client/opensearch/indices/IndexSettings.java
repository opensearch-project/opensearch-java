...
@JsonpDeserializable
public class IndexSettings implements PlainJsonSerializable {
    @Nullable
    ...
    public static class Builder extends ObjectBuilderBase implements ObjectBuilder<IndexSettings> {
        ...
        public final Builder translogDurability(@Nullable String value) {
            if (translog == null) {
                ...
                translog = Translog.of(
                    b -> b.durability(value).flushThresholdSize(translog.flushThresholdSize()).syncInterval(translog.syncInterval())
                );
            }
            return this;
        }
        ...
        public final Builder translogFlushThresholdSize(@Nullable String value) {
            if (translog == null) {
                ...
                translog = Translog.of(
                    b -> b.flushThresholdSize(value).durability(translog.durability()).syncInterval(translog.syncInterval())
                );
            }
            return this;
        }
    ...
    protected static void setupIndexSettingsDeserializer(ObjectDeserializer<IndexSettings.Builder> op) {
        ...
        op.add(Builder::numberOfShards, JsonpDeserializer.stringDeserializer(), "number_of_shards", "index.number_of_shards");
        op.add(Builder::numberOfReplicas, JsonpDeserializer.stringDeserializer(), "number_of_replicas", "index.number_of_replicas");
        op.add(
        ...
        op.add(Builder::translogDurability, JsonpDeserializer.stringDeserializer(), "translog.durability", "index.translog.durability");
        op.add(
