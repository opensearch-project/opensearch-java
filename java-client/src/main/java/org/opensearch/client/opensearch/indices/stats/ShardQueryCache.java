...
@JsonpDeserializable
public class ShardQueryCache implements PlainJsonSerializable {
     ...
     */
    public static final JsonpDeserializer<ShardQueryCache> _DESERIALIZER = ObjectBuilderDeserializer.lazy(
        Builder::new,
