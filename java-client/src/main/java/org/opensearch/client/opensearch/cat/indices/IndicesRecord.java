...
@JsonpDeserializable
public class IndicesRecord implements PlainJsonSerializable {
    @Nullable
    ...
    protected static void setupIndicesRecordDeserializer(ObjectDeserializer<IndicesRecord.Builder> op) {
        ...
        op.add(Builder::bulkTotalOperations, JsonpDeserializer.stringDeserializer(), "bulk.total_operations", "bto", "bulkTotalOperation");
        ...
        op.add(Builder::priBulkTotalSizeInBytes, JsonpDeserializer.stringDeserializer(), "pri.bulk.total_size_in_bytes");
