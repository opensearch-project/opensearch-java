...
public class InferenceAggregate extends AggregateBase implements AggregateVariant {
     ...
     */
    public static final JsonpDeserializer<InferenceAggregate> _DESERIALIZER = ObjectBuilderDeserializer.lazy(
        Builder::new,
        InferenceAggregate::setupInferenceAggregateDeserializer
    );
    ...
    protected static void setupInferenceAggregateDeserializer(ObjectDeserializer<InferenceAggregate.Builder> op) {
        ...
        op.add(
            Builder::featureImportance,
            JsonpDeserializer.arrayDeserializer(InferenceFeatureImportance._DESERIALIZER),
            "feature_importance"
        );
