...
package org.opensearch.client.opensearch._global.explain;
...
public final class ExplanationDetail implements ToJsonp {
	...
	@Nullable
	private final List<org.opensearch.client.opensearch._global.explain.ExplanationDetail> details;
	 ...
	 */
	@Nullable
	public List<org.opensearch.client.opensearch._global.explain.ExplanationDetail> details() {
		return this.details;
	}
	...
	protected void toJsonpInternal(JsonGenerator generator, JsonpMapper mapper) {
		...
		if (this.details != null) {
			...
			for (org.opensearch.client.opensearch._global.explain.ExplanationDetail item0 : this.details) {
	...
	public static class Builder implements ObjectBuilder<ExplanationDetail> {
		...
		@Nullable
		private List<org.opensearch.client.opensearch._global.explain.ExplanationDetail> details;
		...
		public Builder details(
				@Nullable List<org.opensearch.client.opensearch._global.explain.ExplanationDetail> value) {
			this.details = value;
			return this;
		}
		 ...
		 * API name: {@code details}
		 */
		public Builder details(org.opensearch.client.opensearch._global.explain.ExplanationDetail... value) {
		 ...
		 */
		public Builder addDetails(org.opensearch.client.opensearch._global.explain.ExplanationDetail value) {
			if (this.details == null) {
		 ...
		 */
		public Builder details(
				Function<org.opensearch.client.opensearch._global.explain.ExplanationDetail.Builder,
					ObjectBuilder<org.opensearch.client.opensearch._global.explain.ExplanationDetail>> fn) {
			return this.details(
					fn.apply(new org.opensearch.client.opensearch._global.explain.ExplanationDetail.Builder()).build());
		}
	...
	protected static void setupExplanationDetailDeserializer(DelegatingDeserializer<ExplanationDetail.Builder> op) {
		...
		op.add(Builder::details, JsonpDeserializer.arrayDeserializer(
				org.opensearch.client.opensearch._global.explain.ExplanationDetail.DESERIALIZER), "details");
