...
public class SpanMultiTermQuery extends QueryBase implements SpanQueryVariant, QueryVariant {
    ...
    public Builder toBuilder() {
        return new Builder().queryName(queryName()).boost(boost()).match(match);
    }
    ...
    public static class Builder extends QueryBase.AbstractBuilder<Builder> implements ObjectBuilder<SpanMultiTermQuery> {
        private Query match;
