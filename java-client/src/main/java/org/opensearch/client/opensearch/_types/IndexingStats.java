...
public final class IndexingStats implements ToJsonp {
	...
	@Nullable
	private final Map<String, org.opensearch.client.opensearch._types.IndexingStats> types;
	 ...
	 */
	@Nullable
	public Map<String, org.opensearch.client.opensearch._types.IndexingStats> types() {
		return this.types;
	}
	...
	protected void toJsonpInternal(JsonGenerator generator, JsonpMapper mapper) {
		...
		if (this.types != null) {
			...
			generator.writeStartObject();
			for (Map.Entry<String, org.opensearch.client.opensearch._types.IndexingStats> item0 : this.types
					.entrySet()) {
	...
	public static class Builder implements ObjectBuilder<IndexingStats> {
		...
		@Nullable
		private Map<String, org.opensearch.client.opensearch._types.IndexingStats> types;
		 ...
		 * API name: {@code types}
		 */
		public Builder types(@Nullable Map<String, org.opensearch.client.opensearch._types.IndexingStats> value) {
			this.types = value;
			return this;
		}
		 ...
		 */
		public Builder putTypes(String key, org.opensearch.client.opensearch._types.IndexingStats value) {
			if (this.types == null) {
		...
		public Builder types(String key,
				Function<org.opensearch.client.opensearch._types.IndexingStats.Builder,
					ObjectBuilder<org.opensearch.client.opensearch._types.IndexingStats>> fn) {
			return this.types(Collections.singletonMap(key,
					fn.apply(new org.opensearch.client.opensearch._types.IndexingStats.Builder()).build()));
		}
	...
	protected static void setupIndexingStatsDeserializer(DelegatingDeserializer<IndexingStats.Builder> op) {
		...
		op.add(Builder::types, JsonpDeserializer
				.stringMapDeserializer(org.opensearch.client.opensearch._types.IndexingStats.DESERIALIZER), "types");
