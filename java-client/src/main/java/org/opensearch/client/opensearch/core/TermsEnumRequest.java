 ...
 */
@JsonpDeserializable
public class TermsEnumRequest extends RequestBase implements PlainJsonSerializable {
    @Nullable
     ...
     */
    public static final JsonpDeserializer<TermsEnumRequest> _DESERIALIZER = ObjectBuilderDeserializer.lazy(
        Builder::new,
    ...
    public static final Endpoint<TermsEnumRequest, TermsEnumResponse, ErrorResponse> _ENDPOINT = new SimpleEndpoint<>(
        ...
        true,
        TermsEnumResponse._DESERIALIZER
    );
}
