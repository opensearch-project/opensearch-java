...
public class MultiGetResponseItem<TDocument> implements TaggedUnion<MultiGetResponseItem.Kind, Object>, JsonpSerializable {
    ...
    public static <TDocument> JsonpDeserializer<MultiGetResponseItem<TDocument>> createMultiGetResponseItemDeserializer(
        ...
        return new UnionDeserializer.Builder<MultiGetResponseItem<TDocument>, Kind, Object>(MultiGetResponseItem<TDocument>::new, false)
            .addMember(Kind.Result, GetResult.createGetResultDeserializer(tDocumentDeserializer))
            .addMember(Kind.Failure, MultiGetError._DESERIALIZER)
            .build();
    }
