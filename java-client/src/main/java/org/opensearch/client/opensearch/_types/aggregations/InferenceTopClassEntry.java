...
@JsonpDeserializable
public class InferenceTopClassEntry implements PlainJsonSerializable {
     ...
     */
    public static final JsonpDeserializer<InferenceTopClassEntry> _DESERIALIZER = ObjectBuilderDeserializer.lazy(
        Builder::new,
        InferenceTopClassEntry::setupInferenceTopClassEntryDeserializer
    );

    protected static void setupInferenceTopClassEntryDeserializer(ObjectDeserializer<InferenceTopClassEntry.Builder> op) {
