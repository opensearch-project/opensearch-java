 ...
 */
@JsonpDeserializable
public class NodeShutdownStatus implements PlainJsonSerializable {
     ...
     */
    public static final JsonpDeserializer<NodeShutdownStatus> _DESERIALIZER = ObjectBuilderDeserializer.lazy(
        Builder::new,
        NodeShutdownStatus::setupNodeShutdownStatusDeserializer
    );
