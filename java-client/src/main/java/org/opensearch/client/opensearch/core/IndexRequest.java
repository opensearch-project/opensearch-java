...
public class IndexRequest<TDocument> extends RequestBase implements PlainJsonSerializable {
    @Nullable
    ...
    public static final Endpoint<IndexRequest<?>, IndexResponse, ErrorResponse> _ENDPOINT = new SimpleEndpoint<>(
        ...
        request -> {
            ...
            if (propsSet == (_index | _id)) return "PUT";
            if (propsSet == (_index)) return "POST";
