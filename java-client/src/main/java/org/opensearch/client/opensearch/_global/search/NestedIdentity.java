...
public final class NestedIdentity implements ToJsonp {
	...
	@Nullable
	private final org.opensearch.client.opensearch._global.search.NestedIdentity nested;
	 ...
	 */
	@Nullable
	public org.opensearch.client.opensearch._global.search.NestedIdentity nested() {
		return this.nested;
	}
	...
	public static class Builder implements ObjectBuilder<NestedIdentity> {
		...
		@Nullable
		private org.opensearch.client.opensearch._global.search.NestedIdentity nested;
		 ...
		 * API name: {@code _nested}
		 */
		public Builder nested(@Nullable org.opensearch.client.opensearch._global.search.NestedIdentity value) {
			this.nested = value;
			return this;
		}
		...
		public Builder nested(
				Function<org.opensearch.client.opensearch._global.search.NestedIdentity.Builder,
					ObjectBuilder<org.opensearch.client.opensearch._global.search.NestedIdentity>> fn) {
			return this.nested(
					fn.apply(new org.opensearch.client.opensearch._global.search.NestedIdentity.Builder()).build());
		}
	...
	protected static void setupNestedIdentityDeserializer(DelegatingDeserializer<NestedIdentity.Builder> op) {
		...
		op.add(Builder::nested, org.opensearch.client.opensearch._global.search.NestedIdentity.DESERIALIZER, "_nested");
