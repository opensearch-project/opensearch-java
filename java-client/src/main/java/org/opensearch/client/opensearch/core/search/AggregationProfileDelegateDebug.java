...
@JsonpDeserializable
public class AggregationProfileDelegateDebug implements PlainJsonSerializable {
    @Nullable
    ...
    public static AggregationProfileDelegateDebug of(Function<Builder, ObjectBuilder<AggregationProfileDelegateDebug>> fn) {
