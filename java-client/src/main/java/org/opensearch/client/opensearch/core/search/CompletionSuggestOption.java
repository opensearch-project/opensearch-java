...
public class CompletionSuggestOption<TDocument> implements PlainJsonSerializable {
    @Nullable
    ...
    public static class Builder<TDocument> extends ObjectBuilderBase implements ObjectBuilder<CompletionSuggestOption<TDocument>> {
        @Nullable
