...
@JsonpDeserializable
public class ShardsRecord implements PlainJsonSerializable {
    @Nullable
    ...
    protected static void setupShardsRecordDeserializer(ObjectDeserializer<ShardsRecord.Builder> op) {
        ...
        op.add(Builder::seqNoLocalCheckpoint, JsonpDeserializer.stringDeserializer(), "seq_no.local_checkpoint", "sql", "localCheckpoint");
        op.add(
            Builder::seqNoGlobalCheckpoint,
            JsonpDeserializer.stringDeserializer(),
        ...
        op.add(Builder::warmerTotalTime, JsonpDeserializer.stringDeserializer(), "warmer.total_time", "wtt", "warmerTotalTime");
