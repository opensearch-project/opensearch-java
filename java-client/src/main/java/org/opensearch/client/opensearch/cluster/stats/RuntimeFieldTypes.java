...
@JsonpDeserializable
public class RuntimeFieldTypes implements PlainJsonSerializable {
     ...
     */
    public static final JsonpDeserializer<RuntimeFieldTypes> _DESERIALIZER = ObjectBuilderDeserializer.lazy(
        Builder::new,
        RuntimeFieldTypes::setupRuntimeFieldTypesDeserializer
    );
