...
public class AggregationContainer extends TaggedUnion<AggregationContainer.Tag, Object> implements ToJsonp {
	...
	@Nullable
	private final Map<String, org.opensearch.client.opensearch._types.aggregations.AggregationContainer> aggs;
	 ...
	 */
	@Nullable
	public Map<String, org.opensearch.client.opensearch._types.aggregations.AggregationContainer> aggs() {
		return this.aggs;
	}
	 ...
	 */
	public Map<String, org.opensearch.client.opensearch._types.aggregations.AggregationContainer> aggregations() {
	...
	public static class Builder {
		...
		@Nullable
		private Map<String, org.opensearch.client.opensearch._types.aggregations.AggregationContainer> aggs;
		 ...
		 */
		public Builder aggs(
				@Nullable Map<String, org.opensearch.client.opensearch._types.aggregations.AggregationContainer> value) {
			this.aggs = value;
			return this;
		}
		...
		public Builder putAggs(String key,
				org.opensearch.client.opensearch._types.aggregations.AggregationContainer value) {
			if (this.aggs == null) {
		...
		public Builder aggs(String key,
				Function<org.opensearch.client.opensearch._types.aggregations.AggregationContainer.Builder,
					ObjectBuilder<org.opensearch.client.opensearch._types.aggregations.AggregationContainer>> fn) {
			return this.aggs(Collections.singletonMap(key,
					fn.apply(new org.opensearch.client.opensearch._types.aggregations.AggregationContainer.Builder())
							.build()));
		}
		...
		public ContainerBuilder aggregations(
				Map<String, org.opensearch.client.opensearch._types.aggregations.AggregationContainer> v) {
			this.$variant = v;
		...
		public class ContainerBuilder implements ObjectBuilder<AggregationContainer> {
			...
			public ContainerBuilder aggs(String key,
				...
				return this.aggs(Collections.singletonMap(key,
						fn.apply(
								new org.opensearch.client.opensearch._types.aggregations.AggregationContainer.Builder())
								.build()));
			}
	...
	private static JsonpDeserializer<AggregationContainer> buildDeserializer() {
		...
		op.add(Builder::aggs,
				JsonpDeserializer.stringMapDeserializer(
						org.opensearch.client.opensearch._types.aggregations.AggregationContainer.DESERIALIZER),
				"aggs");
