...
@JsonpDeserializable
public class ClusterProcessOpenFileDescriptors implements PlainJsonSerializable {
    ...
    public static ClusterProcessOpenFileDescriptors of(Function<Builder, ObjectBuilder<ClusterProcessOpenFileDescriptors>> fn) {
