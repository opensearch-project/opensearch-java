 ...
 */
public class Jackson3JsonpParser implements LookAheadJsonParser {
    ...
    public Jackson3JsonpParser(tools.jackson.core.JsonParser parser) {
        this.parser = parser;
    }
    ...
    private JsonParsingException convertException(JacksonException je) {
        return new JsonParsingException("Jackson exception: " + je.getMessage(), je, getLocation());
    }
            ...
            while (parser.nextToken() != JsonToken.END_OBJECT) {
                ...
                if (fieldName.equals(name)) {
                    ...
                    return new AbstractMap.SimpleImmutableEntry<>(
                            parser.getString(),
                            new Jackson3JsonpParser(JsonParserSequence.createFlattened(false, tb.asParser(), parser))
                    );
                } else {
    ...
    private void expectNextEvent(JsonToken expected) {
