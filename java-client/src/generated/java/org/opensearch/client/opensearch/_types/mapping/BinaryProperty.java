...
public class BinaryProperty extends DocValuesPropertyBase
    implements
        PropertyVariant,
        ToCopyableBuilder<BinaryProperty.Builder, BinaryProperty> {
     ...
     */
    public static class Builder extends DocValuesPropertyBase.AbstractBuilder<Builder> implements CopyableBuilder<Builder, BinaryProperty> {

        public Builder() {}

        private Builder(BinaryProperty o) {
            super(o);
        }
