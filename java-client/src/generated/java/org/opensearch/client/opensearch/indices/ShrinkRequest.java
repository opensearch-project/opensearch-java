...
public final class ShrinkRequest extends RequestBase
    implements
        PlainJsonSerializable,
        ToCopyableBuilder<ShrinkRequest.Builder, ShrinkRequest> {
     ...
     */
    public static class Builder extends RequestBase.AbstractBuilder<Builder> implements CopyableBuilder<Builder, ShrinkRequest> {
        @Nullable
