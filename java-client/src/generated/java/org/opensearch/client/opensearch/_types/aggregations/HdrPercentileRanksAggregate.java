...
public class HdrPercentileRanksAggregate
    implements
        AggregateVariant,
        PlainJsonSerializable,
        ToCopyableBuilder<HdrPercentileRanksAggregate.Builder, HdrPercentileRanksAggregate> {
    ...
    public static HdrPercentileRanksAggregate of(
     ...
     */
    public static class Builder extends ObjectBuilderBase implements CopyableBuilder<Builder, HdrPercentileRanksAggregate> {
        @Nullable
        ...
        private Builder(HdrPercentileRanksAggregate o) {
    ...
    public static final JsonpDeserializer<HdrPercentileRanksAggregate> _DESERIALIZER = ObjectBuilderDeserializer.lazy(
        Builder::new,
        HdrPercentileRanksAggregate::setupHdrPercentileRanksAggregateDeserializer
    );

    protected static void setupHdrPercentileRanksAggregateDeserializer(ObjectDeserializer<HdrPercentileRanksAggregate.Builder> op) {
    ...
    public boolean equals(Object o) {
        ...
        HdrPercentileRanksAggregate other = (HdrPercentileRanksAggregate) o;
