...
public class SignificantLongTermsAggregate
    implements
        ...
        ToCopyableBuilder<SignificantLongTermsAggregate.Builder, SignificantLongTermsAggregate> {

    @Nullable
    private final Long bgCount;

    @Nonnull
    private final Buckets<SignificantLongTermsBucket> buckets;
    ...
    public static SignificantLongTermsAggregate of(
     ...
     */
    @Nonnull
    public final Buckets<SignificantLongTermsBucket> buckets() {
        return this.buckets;
    }
     ...
     */
    public static class Builder extends ObjectBuilderBase implements CopyableBuilder<Builder, SignificantLongTermsAggregate> {
        @Nullable
        private Long bgCount;
        private Buckets<SignificantLongTermsBucket> buckets;
        @Nullable
        ...
        private Builder(SignificantLongTermsAggregate o) {
         ...
         */
        @Nonnull
        public final Builder buckets(Buckets<SignificantLongTermsBucket> value) {
            this.buckets = value;
            return this;
        }
        ...
        public final Builder buckets(
            Function<Buckets.Builder<SignificantLongTermsBucket>, ObjectBuilder<Buckets<SignificantLongTermsBucket>>> fn
        ) {
            return buckets(fn.apply(new Buckets.Builder<SignificantLongTermsBucket>()).build());
        }
    ...
    protected static void setupSignificantLongTermsAggregateDeserializer(ObjectDeserializer<SignificantLongTermsAggregate.Builder> op) {
        ...
        op.add(Builder::buckets, Buckets.createBucketsDeserializer(SignificantLongTermsBucket._DESERIALIZER), "buckets");
