...
// typedef: ltr.delete_store.Response

@JsonpDeserializable
@Generated("org.opensearch.client.codegen.CodeGenerator")
public class DeleteStoreResponse implements PlainJsonSerializable, ToCopyableBuilder<DeleteStoreResponse.Builder, DeleteStoreResponse> {
    ...
    private DeleteStoreResponse(Builder builder) {
        this.acknowledged = builder.acknowledged;
        this.index = builder.index;
        this.shardsAcknowledged = builder.shardsAcknowledged;
    }

    public static DeleteStoreResponse of(Function<DeleteStoreResponse.Builder, ObjectBuilder<DeleteStoreResponse>> fn) {
    ...
    /**
     * Builder for {@link DeleteStoreResponse}.
     */
    public static class Builder extends ObjectBuilderBase implements CopyableBuilder<Builder, DeleteStoreResponse> {
        @Nullable
        ...
        private Builder(DeleteStoreResponse o) {
        ...
        /**
         * Builds a {@link DeleteStoreResponse}.
         *
    ...
    /**
     * Json deserializer for {@link DeleteStoreResponse}
     */
    public static final JsonpDeserializer<DeleteStoreResponse> _DESERIALIZER = ObjectBuilderDeserializer.lazy(
        Builder::new,
        DeleteStoreResponse::setupDeleteStoreResponseDeserializer
    );

    protected static void setupDeleteStoreResponseDeserializer(ObjectDeserializer<DeleteStoreResponse.Builder> op) {
