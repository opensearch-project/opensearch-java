...
public class WordDelimiterGraphTokenFilter extends TokenFilterBase
    implements
        TokenFilterDefinitionVariant,
        ToCopyableBuilder<WordDelimiterGraphTokenFilter.Builder, WordDelimiterGraphTokenFilter> {
    ...
    public static WordDelimiterGraphTokenFilter of(
    ...
    public static class Builder extends TokenFilterBase.AbstractBuilder<Builder>
        implements
            CopyableBuilder<Builder, WordDelimiterGraphTokenFilter> {
        @Nullable
        ...
        private Builder(WordDelimiterGraphTokenFilter o) {
            super(o);
            this.adjustOffsets = o.adjustOffsets;
            ...
            this.ignoreKeywords = o.ignoreKeywords;
    ...
    public static final JsonpDeserializer<WordDelimiterGraphTokenFilter> _DESERIALIZER = ObjectBuilderDeserializer.lazy(
        Builder::new,
        WordDelimiterGraphTokenFilter::setupWordDelimiterGraphTokenFilterDeserializer
    );
    ...
    public int hashCode() {
        ...
        result = 31 * result + Objects.hashCode(this.adjustOffsets);
        ...
        result = 31 * result + Objects.hashCode(this.ignoreKeywords);
    ...
    public boolean equals(Object o) {
        ...
        WordDelimiterGraphTokenFilter other = (WordDelimiterGraphTokenFilter) o;
        return Objects.equals(this.adjustOffsets, other.adjustOffsets)
            && Objects.equals(this.catenateAll, other.catenateAll)
            ...
            && Objects.equals(this.ignoreKeywords, other.ignoreKeywords)
