...
public class ExistsQuery extends QueryBase implements QueryVariant, ToCopyableBuilder<ExistsQuery.Builder, ExistsQuery> {
    ...
    public static ExistsQuery of(Function<ExistsQuery.Builder, ObjectBuilder<ExistsQuery>> fn) {
     ...
     */
    public static class Builder extends QueryBase.AbstractBuilder<Builder> implements CopyableBuilder<Builder, ExistsQuery> {
        private String field;

        public Builder() {}

        private Builder(ExistsQuery o) {
            super(o);
            this.field = o.field;
        }
    ...
    public boolean equals(Object o) {
        ...
        ExistsQuery other = (ExistsQuery) o;
