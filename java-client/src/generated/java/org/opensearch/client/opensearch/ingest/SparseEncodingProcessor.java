...
// typedef: ingest.SparseEncodingProcessor

@JsonpDeserializable
@Generated("org.opensearch.client.codegen.CodeGenerator")
public class SparseEncodingProcessor extends ProcessorBase
    implements
        ProcessorVariant,
        ToCopyableBuilder<SparseEncodingProcessor.Builder, SparseEncodingProcessor> {
    ...
    private SparseEncodingProcessor(Builder builder) {
        super(builder);
    ...
    public static SparseEncodingProcessor of(Function<SparseEncodingProcessor.Builder, ObjectBuilder<SparseEncodingProcessor>> fn) {
    ...
    public Processor.Kind _processorKind() {
        return Processor.Kind.SparseEncoding;
    }
    ...
    /**
     * Required - Contains key-value pairs that specify the mapping of a text field to a sparse vector field.
     * <p>
    ...
    /**
     * Builder for {@link SparseEncodingProcessor}.
     */
    public static class Builder extends ProcessorBase.AbstractBuilder<Builder>
        implements
            CopyableBuilder<Builder, SparseEncodingProcessor> {
        @Nullable
        ...
        private Builder(SparseEncodingProcessor o) {
            super(o);
        ...
        /**
         * Builds a {@link SparseEncodingProcessor}.
         *
         * @throws NullPointerException if some of the required fields are null.
         */
        @Override
        @Nonnull
        public SparseEncodingProcessor build() {
            _checkSingleUse();

            return new SparseEncodingProcessor(this);
        }
    }
    ...
    /**
     * Json deserializer for {@link SparseEncodingProcessor}
     */
    public static final JsonpDeserializer<SparseEncodingProcessor> _DESERIALIZER = ObjectBuilderDeserializer.lazy(
        Builder::new,
        SparseEncodingProcessor::setupSparseEncodingProcessorDeserializer
    );

    protected static void setupSparseEncodingProcessorDeserializer(ObjectDeserializer<SparseEncodingProcessor.Builder> op) {
    ...
    public boolean equals(Object o) {
        ...
        SparseEncodingProcessor other = (SparseEncodingProcessor) o;
