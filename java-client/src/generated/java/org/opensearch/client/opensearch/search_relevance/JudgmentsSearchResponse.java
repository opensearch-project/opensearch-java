...
// typedef: search_relevance.judgments_search.Response

@JsonpDeserializable
@Generated("org.opensearch.client.codegen.CodeGenerator")
public class JudgmentsSearchResponse<TDocument>
    implements
        PlainJsonSerializable,
        ToCopyableBuilder<JudgmentsSearchResponse.Builder<TDocument>, JudgmentsSearchResponse<TDocument>> {
    ...
    private JudgmentsSearchResponse(Builder<TDocument> builder) {
    ...
    public static <TDocument> JudgmentsSearchResponse<TDocument> of(
        Function<JudgmentsSearchResponse.Builder<TDocument>, ObjectBuilder<JudgmentsSearchResponse<TDocument>>> fn
    ) {
    ...
    /**
     * Builder for {@link JudgmentsSearchResponse}.
     */
    public static class Builder<TDocument> extends ObjectBuilderBase
        implements
            CopyableBuilder<Builder<TDocument>, JudgmentsSearchResponse<TDocument>> {
        @Nullable
        ...
        private Builder(JudgmentsSearchResponse<TDocument> o) {
        ...
        /**
         * Builds a {@link JudgmentsSearchResponse}.
         *
         * @throws NullPointerException if some of the required fields are null.
         */
        @Override
        @Nonnull
        public JudgmentsSearchResponse<TDocument> build() {
            _checkSingleUse();

            return new JudgmentsSearchResponse<>(this);
        }
    }
    ...
    /**
     * Create a JSON deserializer for JudgmentsSearchResponse.
     */
    public static <TDocument> JsonpDeserializer<JudgmentsSearchResponse<TDocument>> createJudgmentsSearchResponseDeserializer(
        JsonpDeserializer<TDocument> tDocumentDeserializer
    ) {
        return ObjectBuilderDeserializer.createForObject(
            Builder<TDocument>::new,
            op -> JudgmentsSearchResponse.setupJudgmentsSearchResponseDeserializer(op, tDocumentDeserializer)
        );
    }

    /**
     * Json deserializer for {@link JudgmentsSearchResponse} based on named deserializers provided by the calling {@code JsonMapper}.
     */
    public static final JsonpDeserializer<JudgmentsSearchResponse<Object>> _DESERIALIZER = createJudgmentsSearchResponseDeserializer(
        new NamedDeserializer<>("org.opensearch.client:Deserializer:search_relevance.judgments_search.TDocument")
    );

    protected static <TDocument> void setupJudgmentsSearchResponseDeserializer(
        ObjectDeserializer<JudgmentsSearchResponse.Builder<TDocument>> op,
        JsonpDeserializer<TDocument> tDocumentDeserializer
    ) {
    ...
    public boolean equals(Object o) {
        ...
        JudgmentsSearchResponse<?> other = (JudgmentsSearchResponse<?>) o;
