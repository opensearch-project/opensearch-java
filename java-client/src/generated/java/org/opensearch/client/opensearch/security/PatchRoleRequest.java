...
// typedef: security.patch_role.Request
...
public final class PatchRoleRequest extends RequestBase
    implements
        PlainJsonSerializable,
        ToCopyableBuilder<PatchRoleRequest.Builder, PatchRoleRequest> {
    ...
    public static PatchRoleRequest of(Function<PatchRoleRequest.Builder, ObjectBuilder<PatchRoleRequest>> fn) {
    ...
    /**
     * Builder for {@link PatchRoleRequest}.
     */
    public static class Builder extends RequestBase.AbstractBuilder<Builder> implements CopyableBuilder<Builder, PatchRoleRequest> {
        ...
        /**
         * Builds a {@link PatchRoleRequest}.
         *
    ...
    public static final JsonpDeserializer<PatchRoleRequest> _DESERIALIZER = createPatchRoleRequestDeserializer();
    ...
    /**
     * Endpoint "{@code security.patch_role}".
     */
    public static final Endpoint<PatchRoleRequest, PatchRoleResponse, ErrorResponse> _ENDPOINT = new SimpleEndpoint<>(
        // Request method
        request -> "PATCH",
        // Request path
        request -> {
        ...
        true,
        PatchRoleResponse._DESERIALIZER
    );
