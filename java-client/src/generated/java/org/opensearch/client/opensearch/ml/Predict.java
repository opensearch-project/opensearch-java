...
public class Predict implements PlainJsonSerializable, ToCopyableBuilder<Predict.Builder, Predict> {
    ...
    private Predict(Builder builder) {
    ...
    public static Predict of(Function<Predict.Builder, ObjectBuilder<Predict>> fn) {
    ...
    /**
     * Builder for {@link Predict}.
     */
    public static class Builder extends ObjectBuilderBase implements CopyableBuilder<Builder, Predict> {
        @Nullable
    ...
    /**
     * Json deserializer for {@link Predict}
     */
    public static final JsonpDeserializer<Predict> _DESERIALIZER = ObjectBuilderDeserializer.lazy(
        Builder::new,
        Predict::setupPredictDeserializer
    );

    protected static void setupPredictDeserializer(ObjectDeserializer<Predict.Builder> op) {
