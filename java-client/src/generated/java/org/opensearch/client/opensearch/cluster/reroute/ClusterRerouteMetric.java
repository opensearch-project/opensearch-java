...
// typedef: cluster.reroute.Metric
...
public enum ClusterRerouteMetric implements JsonEnum {
    ...
    ClusterRerouteMetric(String jsonValue) {
    ...
    public static final JsonEnum.Deserializer<ClusterRerouteMetric> _DESERIALIZER = new JsonEnum.Deserializer<>(
        ClusterRerouteMetric.values()
    );
}
