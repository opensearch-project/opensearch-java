...
public class MissingAggregate extends SingleBucketAggregateBase implements ToCopyableBuilder<MissingAggregate.Builder, MissingAggregate> {
    ...
    public static class Builder extends SingleBucketAggregateBase.AbstractBuilder<Builder>
        implements
            CopyableBuilder<Builder, MissingAggregate> {

        public Builder() {}

        private Builder(MissingAggregate o) {
            super(o);
        }
