...
public class AvgAggregate implements AggregateVariant, PlainJsonSerializable, ToCopyableBuilder<AvgAggregate.Builder, AvgAggregate> {
     ...
     */
    public static class Builder extends ObjectBuilderBase implements CopyableBuilder<Builder, AvgAggregate> {
        @Nullable
