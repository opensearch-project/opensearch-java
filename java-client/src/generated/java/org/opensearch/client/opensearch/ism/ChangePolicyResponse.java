...
// typedef: ism.change_policy.Response

@JsonpDeserializable
@Generated("org.opensearch.client.codegen.CodeGenerator")
public class ChangePolicyResponse implements PlainJsonSerializable, ToCopyableBuilder<ChangePolicyResponse.Builder, ChangePolicyResponse> {
    ...
    private ChangePolicyResponse(Builder builder) {
    ...
    /**
     * Builder for {@link ChangePolicyResponse}.
     */
    public static class Builder extends ObjectBuilderBase implements CopyableBuilder<Builder, ChangePolicyResponse> {
        @Nullable
        ...
        private Builder(ChangePolicyResponse o) {
        ...
        /**
         * Builds a {@link ChangePolicyResponse}.
         *
         * @throws NullPointerException if some of the required fields are null.
         */
        @Override
        @Nonnull
        public ChangePolicyResponse build() {
            _checkSingleUse();

            return new ChangePolicyResponse(this);
        }
    }
    ...
    /**
     * Json deserializer for {@link ChangePolicyResponse}
     */
    public static final JsonpDeserializer<ChangePolicyResponse> _DESERIALIZER = ObjectBuilderDeserializer.lazy(
        Builder::new,
        ChangePolicyResponse::setupChangePolicyResponseDeserializer
    );
    ...
    public boolean equals(Object o) {
        ...
        ChangePolicyResponse other = (ChangePolicyResponse) o;
