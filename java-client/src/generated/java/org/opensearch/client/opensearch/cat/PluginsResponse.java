...
public class PluginsResponse implements PlainJsonSerializable, ToCopyableBuilder<PluginsResponse.Builder, PluginsResponse> {
    ...
    public static PluginsResponse of(Function<PluginsResponse.Builder, ObjectBuilder<PluginsResponse>> fn) {
     ...
     */
    public static class Builder extends ObjectBuilderBase implements CopyableBuilder<Builder, PluginsResponse> {
        private List<PluginsRecord> valueBody;

        public Builder() {}

        private Builder(PluginsResponse o) {
