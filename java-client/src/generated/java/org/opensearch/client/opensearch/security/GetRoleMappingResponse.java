...
public class GetRoleMappingResponse extends DictionaryResponse<String, RoleMapping> {
    ...
    public static GetRoleMappingResponse of(Function<GetRoleMappingResponse.Builder, ObjectBuilder<GetRoleMappingResponse>> fn) {
     ...
     */
    public static final JsonpDeserializer<GetRoleMappingResponse> _DESERIALIZER = ObjectBuilderDeserializer.lazy(
        Builder::new,
        GetRoleMappingResponse::setupGetRoleMappingResponseDeserializer
    );
