...
// typedef: search_relevance.put_query_sets.Response

@JsonpDeserializable
@Generated("org.opensearch.client.codegen.CodeGenerator")
public class PutQuerySetsResponse implements PlainJsonSerializable, ToCopyableBuilder<PutQuerySetsResponse.Builder, PutQuerySetsResponse> {
    ...
    private PutQuerySetsResponse(Builder builder) {
        this.querySetId = builder.querySetId;
        this.querySetResult = builder.querySetResult;
    }

    public static PutQuerySetsResponse of(Function<PutQuerySetsResponse.Builder, ObjectBuilder<PutQuerySetsResponse>> fn) {
    ...
    /**
     * Builder for {@link PutQuerySetsResponse}.
     */
    public static class Builder extends ObjectBuilderBase implements CopyableBuilder<Builder, PutQuerySetsResponse> {
        @Nullable
        ...
        private Builder(PutQuerySetsResponse o) {
        ...
        /**
         * Builds a {@link PutQuerySetsResponse}.
         *
         * @throws NullPointerException if some of the required fields are null.
         */
        @Override
        @Nonnull
        public PutQuerySetsResponse build() {
            _checkSingleUse();

            return new PutQuerySetsResponse(this);
        }
    }
    ...
    /**
     * Json deserializer for {@link PutQuerySetsResponse}
     */
    public static final JsonpDeserializer<PutQuerySetsResponse> _DESERIALIZER = ObjectBuilderDeserializer.lazy(
        Builder::new,
        PutQuerySetsResponse::setupPutQuerySetsResponseDeserializer
    );

    protected static void setupPutQuerySetsResponseDeserializer(ObjectDeserializer<PutQuerySetsResponse.Builder> op) {
    ...
    public boolean equals(Object o) {
        ...
        PutQuerySetsResponse other = (PutQuerySetsResponse) o;
