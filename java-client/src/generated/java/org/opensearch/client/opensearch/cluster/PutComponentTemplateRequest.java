...
public class PutComponentTemplateRequest extends RequestBase
    implements
     ...
     */
    public static class Builder extends ObjectBuilderBase implements CopyableBuilder<Builder, PutComponentTemplateRequest> {
        @Nullable
