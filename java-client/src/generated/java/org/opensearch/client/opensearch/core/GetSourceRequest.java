...
public final class GetSourceRequest extends RequestBase implements ToCopyableBuilder<GetSourceRequest.Builder, GetSourceRequest> {
    ...
    /**
     * The specific version type. One of <code>internal</code>, <code>external</code>, <code>external_gte</code>.
     * <p>
     ...
     */
    public static class Builder extends RequestBase.AbstractBuilder<Builder> implements CopyableBuilder<Builder, GetSourceRequest> {
        private String id;
        ...
        private Builder(GetSourceRequest o) {
            super(o);
            this.id = o.id;
            this.index = o.index;
    ...
    public static final SimpleEndpoint<GetSourceRequest, ?> _ENDPOINT = new SimpleEndpoint<>(
        ...
        false,
        GetSourceResponse._DESERIALIZER
    );
