...
public class GetStatsResponse implements PlainJsonSerializable, ToCopyableBuilder<GetStatsResponse.Builder, GetStatsResponse> {
    ...
    /**
     * Singleton instance for {@link GetStatsResponse}.
     */
    public static final GetStatsResponse _INSTANCE = builder().build();

    public static final JsonpDeserializer<GetStatsResponse> _DESERIALIZER = JsonpDeserializer.emptyObject(GetStatsResponse._INSTANCE);
