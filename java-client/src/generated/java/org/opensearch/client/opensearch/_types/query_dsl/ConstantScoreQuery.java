...
public class ConstantScoreQuery extends QueryBase
    implements
        QueryVariant,
        ToCopyableBuilder<ConstantScoreQuery.Builder, ConstantScoreQuery> {
    ...
    public static ConstantScoreQuery of(Function<ConstantScoreQuery.Builder, ObjectBuilder<ConstantScoreQuery>> fn) {
     ...
     */
    public static class Builder extends QueryBase.AbstractBuilder<Builder> implements CopyableBuilder<Builder, ConstantScoreQuery> {
        private Query filter;

        public Builder() {}

        private Builder(ConstantScoreQuery o) {
            super(o);
