...
public class TasksResponse implements PlainJsonSerializable, ToCopyableBuilder<TasksResponse.Builder, TasksResponse> {
    ...
    public static TasksResponse of(Function<TasksResponse.Builder, ObjectBuilder<TasksResponse>> fn) {
     ...
     */
    public static class Builder extends ObjectBuilderBase implements CopyableBuilder<Builder, TasksResponse> {
        private List<TasksRecord> valueBody;

        public Builder() {}

        private Builder(TasksResponse o) {
