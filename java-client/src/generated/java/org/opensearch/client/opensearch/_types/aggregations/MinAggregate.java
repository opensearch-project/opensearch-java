...
public class MinAggregate implements AggregateVariant, PlainJsonSerializable, ToCopyableBuilder<MinAggregate.Builder, MinAggregate> {
    ...
    public static MinAggregate of(Function<MinAggregate.Builder, ObjectBuilder<MinAggregate>> fn) {
     ...
     */
    public static class Builder extends ObjectBuilderBase implements CopyableBuilder<Builder, MinAggregate> {
        @Nullable
        ...
        private Builder(MinAggregate o) {
    ...
    public boolean equals(Object o) {
        ...
        MinAggregate other = (MinAggregate) o;
