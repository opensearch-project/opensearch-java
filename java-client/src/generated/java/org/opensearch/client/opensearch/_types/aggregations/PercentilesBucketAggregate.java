...
public class PercentilesBucketAggregate
    implements
        AggregateVariant,
        PlainJsonSerializable,
        ToCopyableBuilder<PercentilesBucketAggregate.Builder, PercentilesBucketAggregate> {
    ...
    public static PercentilesBucketAggregate of(
     ...
     */
    public static class Builder extends ObjectBuilderBase implements CopyableBuilder<Builder, PercentilesBucketAggregate> {
        @Nullable
        ...
        private Builder(PercentilesBucketAggregate o) {
    ...
    public boolean equals(Object o) {
        ...
        PercentilesBucketAggregate other = (PercentilesBucketAggregate) o;
