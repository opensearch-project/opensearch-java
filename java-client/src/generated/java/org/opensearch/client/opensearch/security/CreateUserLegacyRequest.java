...
// typedef: security.create_user_legacy.Request
...
public final class CreateUserLegacyRequest extends RequestBase
    implements
        PlainJsonSerializable,
        ToCopyableBuilder<CreateUserLegacyRequest.Builder, CreateUserLegacyRequest> {
    ...
    private CreateUserLegacyRequest(Builder builder) {
        super(builder);
    ...
    /**
     * Builder for {@link CreateUserLegacyRequest}.
     */
    public static class Builder extends RequestBase.AbstractBuilder<Builder> implements CopyableBuilder<Builder, CreateUserLegacyRequest> {
        @Nullable
        ...
        private Builder(CreateUserLegacyRequest o) {
            super(o);
        ...
        /**
         * Builds a {@link CreateUserLegacyRequest}.
         *
         * @throws NullPointerException if some of the required fields are null.
         */
        @Override
        @Nonnull
        public CreateUserLegacyRequest build() {
            _checkSingleUse();

            return new CreateUserLegacyRequest(this);
        }
    }
    ...
    /**
     * Json deserializer for {@link CreateUserLegacyRequest}
     */
    public static final JsonpDeserializer<CreateUserLegacyRequest> _DESERIALIZER = ObjectBuilderDeserializer.lazy(
        Builder::new,
        CreateUserLegacyRequest::setupCreateUserLegacyRequestDeserializer
    );
    ...
    /**
     * Endpoint "{@code security.create_user_legacy}".
     */
    public static final Endpoint<CreateUserLegacyRequest, CreateUserLegacyResponse, ErrorResponse> _ENDPOINT = new SimpleEndpoint<>(
        // Request method
        request -> "PUT",
        // Request path
        request -> {
        ...
        true,
        CreateUserLegacyResponse._DESERIALIZER
    );
    ...
    public boolean equals(Object o) {
        ...
        CreateUserLegacyRequest other = (CreateUserLegacyRequest) o;
