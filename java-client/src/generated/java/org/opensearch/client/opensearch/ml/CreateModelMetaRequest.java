...
// typedef: ml.create_model_meta.Request
...
public final class CreateModelMetaRequest extends RequestBase
    implements
        PlainJsonSerializable,
        ToCopyableBuilder<CreateModelMetaRequest.Builder, CreateModelMetaRequest> {
    ...
    /**
     * Builder for {@link CreateModelMetaRequest}.
     */
    public static class Builder extends RequestBase.AbstractBuilder<Builder> implements CopyableBuilder<Builder, CreateModelMetaRequest> {
        ...
        /**
         * Builds a {@link CreateModelMetaRequest}.
         *
    ...
    /**
     * Json deserializer for {@link CreateModelMetaRequest}
     */
    public static final JsonpDeserializer<CreateModelMetaRequest> _DESERIALIZER = ObjectBuilderDeserializer.lazy(
        Builder::new,
        CreateModelMetaRequest::setupCreateModelMetaRequestDeserializer
    );
    ...
    /**
     * Endpoint "{@code ml.create_model_meta}".
     */
    public static final Endpoint<CreateModelMetaRequest, CreateModelMetaResponse, ErrorResponse> _ENDPOINT = new SimpleEndpoint<>(
        // Request method
        request -> "POST",
        // Request path
        request -> "/_plugins/_ml/models/meta",
        // Request parameters
        request -> {
        ...
        true,
        CreateModelMetaResponse._DESERIALIZER
    );
