...
public class SignificantLongTermsBucket extends SignificantTermsBucketBase
    implements
        ToCopyableBuilder<SignificantLongTermsBucket.Builder, SignificantLongTermsBucket> {
    ...
    public static SignificantLongTermsBucket of(
        Function<SignificantLongTermsBucket.Builder, ObjectBuilder<SignificantLongTermsBucket>> fn
    ) {
    ...
    public static class Builder extends SignificantTermsBucketBase.AbstractBuilder<Builder>
        implements
            CopyableBuilder<Builder, SignificantLongTermsBucket> {
        private Long key;
        @Nullable
        ...
        private Builder(SignificantLongTermsBucket o) {
            super(o);
            this.key = o.key;
    ...
    public boolean equals(Object o) {
        ...
        SignificantLongTermsBucket other = (SignificantLongTermsBucket) o;
