...
public class UniqueTokenFilter extends TokenFilterBase
    ...
    public static UniqueTokenFilter of(Function<UniqueTokenFilter.Builder, ObjectBuilder<UniqueTokenFilter>> fn) {
     ...
     */
    public static final JsonpDeserializer<UniqueTokenFilter> _DESERIALIZER = ObjectBuilderDeserializer.lazy(
        Builder::new,
        UniqueTokenFilter::setupUniqueTokenFilterDeserializer
    );
