...
public class PostSearchWithIndexRequest extends RequestBase implements JsonpSerializable {
    ...
    public static PostSearchWithIndexRequest of(
            Function<Builder, ObjectBuilder<PostSearchWithIndexRequest>> fn) {
    ...
    public static class Builder extends ObjectBuilderBase
        ...
        /**
         * Builds a {@link PostSearchWithIndexRequest}.
         *
         * @throws NullPointerException if some of the required fields are null.
         */
        public PostSearchWithIndexRequest build() {
            _checkSingleUse();

            return new PostSearchWithIndexRequest(this);
        }
    }

    public static final JsonpDeserializer<PostSearchWithIndexRequest> _DESERIALIZER =
            ObjectBuilderDeserializer.lazy(
                    Builder::new,
                    PostSearchWithIndexRequest::setupPostSearchWithIndexRequestDeserializer);

    protected static void setupPostSearchWithIndexRequestDeserializer(
            ObjectDeserializer<PostSearchWithIndexRequest.Builder> op) {
    ...
    public static final Endpoint<
                    PostSearchWithIndexRequest, PostSearchWithIndexResponse, ErrorResponse>
            _ENDPOINT =
                    new SimpleEndpoint<>(
                            // Request method
                            request -> {
                            ...
                            request -> {
                                ...
                                if (request.analyzeWildcard != null) {
                                    params.put(
                                            "analyze_wildcard",
                                            String.valueOf(request.analyzeWildcard));
                                }
                                ...
                                if (request.defaultOperator != null) {
                                    params.put(
                                            "default_operator",
                                            request.defaultOperator.jsonValue());
                                }
                                if (request.df != null) {
                                ...
                                if (request.requestCache != null) {
                                    params.put(
                                            "request_cache", String.valueOf(request.requestCache));
                                }
                                ...
                                if (request.terminateAfter != null) {
                                    params.put(
                                            "terminate_after",
                                            String.valueOf(request.terminateAfter));
                                }
                                ...
                                if (request.trackTotalHits != null) {
                                    params.put(
                                            "track_total_hits",
                                            String.valueOf(request.trackTotalHits));
                                }
                            ...
                            true,
                            PostSearchWithIndexResponse._DESERIALIZER);
}
