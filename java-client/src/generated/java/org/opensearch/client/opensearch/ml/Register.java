...
public class Register implements PlainJsonSerializable, ToCopyableBuilder<Register.Builder, Register> {
    ...
    public static Register of(Function<Register.Builder, ObjectBuilder<Register>> fn) {
     ...
     */
    public static class Builder extends ObjectBuilderBase implements CopyableBuilder<Builder, Register> {
        @Nullable
    ...
    /**
     * Json deserializer for {@link Register}
     */
    public static final JsonpDeserializer<Register> _DESERIALIZER = ObjectBuilderDeserializer.lazy(
        Builder::new,
        Register::setupRegisterDeserializer
    );

    protected static void setupRegisterDeserializer(ObjectDeserializer<Register.Builder> op) {
