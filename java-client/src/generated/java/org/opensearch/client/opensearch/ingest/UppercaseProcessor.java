...
// typedef: ingest.UppercaseProcessor

@JsonpDeserializable
@Generated("org.opensearch.client.codegen.CodeGenerator")
public class UppercaseProcessor extends ProcessorBase
    implements
        ProcessorVariant,
        ToCopyableBuilder<UppercaseProcessor.Builder, UppercaseProcessor> {
    ...
    public static UppercaseProcessor of(Function<UppercaseProcessor.Builder, ObjectBuilder<UppercaseProcessor>> fn) {
     ...
     */
    public static class Builder extends ProcessorBase.AbstractBuilder<Builder> implements CopyableBuilder<Builder, UppercaseProcessor> {
        ...
        private Builder(UppercaseProcessor o) {
            super(o);
            this.field = o.field;
     ...
     */
    public static final JsonpDeserializer<UppercaseProcessor> _DESERIALIZER = ObjectBuilderDeserializer.lazy(
        Builder::new,
        UppercaseProcessor::setupUppercaseProcessorDeserializer
    );
    ...
    public boolean equals(Object o) {
        ...
        UppercaseProcessor other = (UppercaseProcessor) o;
