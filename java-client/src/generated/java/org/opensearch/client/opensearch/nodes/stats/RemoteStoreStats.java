...
// typedef: nodes.stats.RemoteStoreStats
...
public class RemoteStoreStats implements PlainJsonSerializable, ToCopyableBuilder<RemoteStoreStats.Builder, RemoteStoreStats> {
    ...
    private RemoteStoreStats(Builder builder) {
        this.lastSuccessfulFetchOfPinnedTimestamps = builder.lastSuccessfulFetchOfPinnedTimestamps;
    }
     ...
     * <p>
     * API name: {@code last_successful_fetch_of_pinned_timestamps}
     * </p>
     */
    @Nullable
    public final Long lastSuccessfulFetchOfPinnedTimestamps() {
    ...
    protected void serializeInternal(JsonGenerator generator, JsonpMapper mapper) {
        if (this.lastSuccessfulFetchOfPinnedTimestamps != null) {
            generator.writeKey("last_successful_fetch_of_pinned_timestamps");
            generator.write(this.lastSuccessfulFetchOfPinnedTimestamps);
        }
    }
    ...
    public static class Builder extends ObjectBuilderBase implements CopyableBuilder<Builder, RemoteStoreStats> {
        ...
        private Builder(RemoteStoreStats o) {
            this.lastSuccessfulFetchOfPinnedTimestamps = o.lastSuccessfulFetchOfPinnedTimestamps;
        }
         ...
         */
        @Nonnull
        public final Builder lastSuccessfulFetchOfPinnedTimestamps(@Nullable Long value) {
            this.lastSuccessfulFetchOfPinnedTimestamps = value;
            return this;
        }
    ...
    protected static void setupRemoteStoreStatsDeserializer(ObjectDeserializer<RemoteStoreStats.Builder> op) {
        op.add(
            Builder::lastSuccessfulFetchOfPinnedTimestamps,
    ...
    public int hashCode() {
        int result = 17;
        result = 31 * result + Objects.hashCode(this.lastSuccessfulFetchOfPinnedTimestamps);
        return result;
    }
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.lastSuccessfulFetchOfPinnedTimestamps, other.lastSuccessfulFetchOfPinnedTimestamps);
    }
}
