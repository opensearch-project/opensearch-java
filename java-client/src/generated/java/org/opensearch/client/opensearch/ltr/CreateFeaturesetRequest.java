...
// typedef: ltr.create_featureset.Request

/**
 * Create or update a feature set in the default feature store.
 */
@Generated("org.opensearch.client.codegen.CodeGenerator")
public final class CreateFeaturesetRequest extends RequestBase
    implements
    ...
    private CreateFeaturesetRequest(Builder builder) {
        super(builder);
    ...
    /**
     * Builder for {@link CreateFeaturesetRequest}.
     */
    public static class Builder extends RequestBase.AbstractBuilder<Builder> implements CopyableBuilder<Builder, CreateFeaturesetRequest> {
        private String id;
        @Nullable
        ...
        private Builder(CreateFeaturesetRequest o) {
            super(o);
            this.id = o.id;
        ...
        /**
         * Builds a {@link CreateFeaturesetRequest}.
         *
    ...
    /**
     * Endpoint "{@code ltr.create_featureset}".
     */
    public static final Endpoint<CreateFeaturesetRequest, CreateFeaturesetResponse, ErrorResponse> _ENDPOINT = new SimpleEndpoint<>(
        // Request method
        request -> "PUT",
        // Request path
        request -> {
        ...
        false,
        CreateFeaturesetResponse._DESERIALIZER
    );
    ...
    public boolean equals(Object o) {
        ...
        CreateFeaturesetRequest other = (CreateFeaturesetRequest) o;
