...
public class GetRoleResponse extends DictionaryResponse<String, Role> {
    ...
    public static GetRoleResponse of(Function<GetRoleResponse.Builder, ObjectBuilder<GetRoleResponse>> fn) {
     ...
     */
    public static final JsonpDeserializer<GetRoleResponse> _DESERIALIZER = ObjectBuilderDeserializer.lazy(
        Builder::new,
