...
public class PutComponentTemplateResponse extends AcknowledgedResponseBase
    implements
        ToCopyableBuilder<PutComponentTemplateResponse.Builder, PutComponentTemplateResponse> {
    ...
    public static PutComponentTemplateResponse of(
        Function<PutComponentTemplateResponse.Builder, ObjectBuilder<PutComponentTemplateResponse>> fn
    ) {
    ...
    public static class Builder extends AcknowledgedResponseBase.AbstractBuilder<Builder>
        implements
            CopyableBuilder<Builder, PutComponentTemplateResponse> {

        public Builder() {}

        private Builder(PutComponentTemplateResponse o) {
            super(o);
        }
