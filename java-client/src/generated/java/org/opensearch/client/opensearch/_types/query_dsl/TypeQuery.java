...
public class TypeQuery extends QueryBase implements QueryVariant, ToCopyableBuilder<TypeQuery.Builder, TypeQuery> {
    ...
    public static TypeQuery of(Function<TypeQuery.Builder, ObjectBuilder<TypeQuery>> fn) {
     ...
     */
    public static class Builder extends QueryBase.AbstractBuilder<Builder> implements CopyableBuilder<Builder, TypeQuery> {
        private String value;

        public Builder() {}

        private Builder(TypeQuery o) {
            super(o);
            this.value = o.value;
        }
