...
public final class DeleteUserRequest extends RequestBase implements ToCopyableBuilder<DeleteUserRequest.Builder, DeleteUserRequest> {
    ...
    public static DeleteUserRequest of(Function<DeleteUserRequest.Builder, ObjectBuilder<DeleteUserRequest>> fn) {
     ...
     */
    public static class Builder extends RequestBase.AbstractBuilder<Builder> implements CopyableBuilder<Builder, DeleteUserRequest> {
        private String username;

        public Builder() {}

        private Builder(DeleteUserRequest o) {
            super(o);
    ...
    public static final Endpoint<DeleteUserRequest, DeleteUserResponse, ErrorResponse> _ENDPOINT = new SimpleEndpoint<>(
        ...
        false,
        DeleteUserResponse._DESERIALIZER
    );
