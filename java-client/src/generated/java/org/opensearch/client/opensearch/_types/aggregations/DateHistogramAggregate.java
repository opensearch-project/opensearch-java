...
public class DateHistogramAggregate<TBucket>
    implements
        AggregateVariant,
        PlainJsonSerializable,
        ToCopyableBuilder<DateHistogramAggregate.Builder<TBucket>, DateHistogramAggregate<TBucket>> {
    ...
    private DateHistogramAggregate(Builder<TBucket> builder) {
        this.buckets = ApiTypeHelper.requireNonNull(builder.buckets, this, "buckets");
        this.meta = ApiTypeHelper.unmodifiable(builder.meta);
    }

    public static <TBucket> DateHistogramAggregate<TBucket> of(
        Function<DateHistogramAggregate.Builder<TBucket>, ObjectBuilder<DateHistogramAggregate<TBucket>>> fn
    ) {
    ...
    public static class Builder<TBucket> extends ObjectBuilderBase
        implements
            CopyableBuilder<Builder<TBucket>, DateHistogramAggregate<TBucket>> {
        ...
        private Builder(DateHistogramAggregate<TBucket> o) {
        ...
        @Override
        @Nonnull
        public DateHistogramAggregate<TBucket> build() {
            _checkSingleUse();
    ...
    /**
     * Create a JSON deserializer for DateHistogramAggregate.
     */
    public static <TBucket> JsonpDeserializer<DateHistogramAggregate<TBucket>> createDateHistogramAggregateDeserializer(
        JsonpDeserializer<TBucket> tBucketDeserializer
    ) {
        return ObjectBuilderDeserializer.createForObject(
            Builder<TBucket>::new,
            op -> DateHistogramAggregate.setupDateHistogramAggregateDeserializer(op, tBucketDeserializer)
        );
    }

    protected static <TBucket> void setupDateHistogramAggregateDeserializer(
        ObjectDeserializer<DateHistogramAggregate.Builder<TBucket>> op,
        JsonpDeserializer<TBucket> tBucketDeserializer
    ) {
    ...
    public boolean equals(Object o) {
        ...
        DateHistogramAggregate<?> other = (DateHistogramAggregate<?>) o;
