...
public class DateHistogramAggregate
    ...
    @Nonnull
    private final Buckets<DateHistogramBucket> buckets;
     ...
     */
    @Nonnull
    public final Buckets<DateHistogramBucket> buckets() {
        return this.buckets;
    }
     ...
     */
    public static class Builder extends ObjectBuilderBase implements CopyableBuilder<Builder, DateHistogramAggregate> {
        private Buckets<DateHistogramBucket> buckets;
        @Nullable
         ...
         */
        @Nonnull
        public final Builder buckets(Buckets<DateHistogramBucket> value) {
            this.buckets = value;
            return this;
        }
         ...
         */
        @Nonnull
        public final Builder buckets(Function<Buckets.Builder<DateHistogramBucket>, ObjectBuilder<Buckets<DateHistogramBucket>>> fn) {
            return buckets(fn.apply(new Buckets.Builder<DateHistogramBucket>()).build());
        }
    ...
    protected static void setupDateHistogramAggregateDeserializer(ObjectDeserializer<DateHistogramAggregate.Builder> op) {
        op.add(Builder::buckets, Buckets.createBucketsDeserializer(DateHistogramBucket._DESERIALIZER), "buckets");
