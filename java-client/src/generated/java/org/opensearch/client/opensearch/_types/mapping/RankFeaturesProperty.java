...
public class RankFeaturesProperty extends PropertyBase
    implements
        PropertyVariant,
        ToCopyableBuilder<RankFeaturesProperty.Builder, RankFeaturesProperty> {
    ...
    public static RankFeaturesProperty of(Function<RankFeaturesProperty.Builder, ObjectBuilder<RankFeaturesProperty>> fn) {
     ...
     */
    public static class Builder extends PropertyBase.AbstractBuilder<Builder> implements CopyableBuilder<Builder, RankFeaturesProperty> {

        public Builder() {}

        private Builder(RankFeaturesProperty o) {
            super(o);
        }
