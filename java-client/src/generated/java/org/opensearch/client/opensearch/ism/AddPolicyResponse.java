...
// typedef: ism.add_policy.Response

@JsonpDeserializable
@Generated("org.opensearch.client.codegen.CodeGenerator")
public class AddPolicyResponse implements PlainJsonSerializable, ToCopyableBuilder<AddPolicyResponse.Builder, AddPolicyResponse> {
    ...
    private AddPolicyResponse(Builder builder) {
    ...
    /**
     * Builder for {@link AddPolicyResponse}.
     */
    public static class Builder extends ObjectBuilderBase implements CopyableBuilder<Builder, AddPolicyResponse> {
        @Nullable
        ...
        private Builder(AddPolicyResponse o) {
        ...
        /**
         * Builds a {@link AddPolicyResponse}.
         *
         * @throws NullPointerException if some of the required fields are null.
         */
        @Override
        @Nonnull
        public AddPolicyResponse build() {
            _checkSingleUse();

            return new AddPolicyResponse(this);
        }
    }
    ...
    /**
     * Json deserializer for {@link AddPolicyResponse}
     */
    public static final JsonpDeserializer<AddPolicyResponse> _DESERIALIZER = ObjectBuilderDeserializer.lazy(
        Builder::new,
        AddPolicyResponse::setupAddPolicyResponseDeserializer
    );
    ...
    public boolean equals(Object o) {
        ...
        AddPolicyResponse other = (AddPolicyResponse) o;
