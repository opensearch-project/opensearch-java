...
public class TokenFilterDefinition implements TaggedUnion<TokenFilterDefinition.Kind, TokenFilterDefinitionVariant>, PlainJsonSerializable {
    /**
     ...
     *
     * @throws IllegalStateException if the current variant is not the {@code asciifolding} kind.
     */
     ...
     *
     * @throws IllegalStateException if the current variant is not the {@code common_grams} kind.
     */
     ...
     *
     * @throws IllegalStateException if the current variant is not the {@code condition} kind.
     */
     ...
     *
     * @throws IllegalStateException if the current variant is not the {@code delimited_payload} kind.
     */
     ...
     *
     * @throws IllegalStateException if the current variant is not the {@code dictionary_decompounder} kind.
     */
     ...
     *
     * @throws IllegalStateException if the current variant is not the {@code elision} kind.
     */
     ...
     *
     * @throws IllegalStateException if the current variant is not the {@code hunspell} kind.
     */
     ...
     *
     * @throws IllegalStateException if the current variant is not the {@code hyphenation_decompounder} kind.
     */
     ...
     *
     * @throws IllegalStateException if the current variant is not the {@code icu_collation} kind.
     */
     ...
     *
     * @throws IllegalStateException if the current variant is not the {@code icu_folding} kind.
     */
     ...
     *
     * @throws IllegalStateException if the current variant is not the {@code icu_transform} kind.
     */
     ...
     *
     * @throws IllegalStateException if the current variant is not the {@code keep} kind.
     */
     ...
     *
     * @throws IllegalStateException if the current variant is not the {@code keep_types} kind.
     */
     ...
     *
     * @throws IllegalStateException if the current variant is not the {@code keyword_marker} kind.
     */
     ...
     *
     * @throws IllegalStateException if the current variant is not the {@code kstem} kind.
     */
     ...
     *
     * @throws IllegalStateException if the current variant is not the {@code kuromoji_part_of_speech} kind.
     */
     ...
     *
     * @throws IllegalStateException if the current variant is not the {@code kuromoji_readingform} kind.
     */
     ...
     *
     * @throws IllegalStateException if the current variant is not the {@code kuromoji_stemmer} kind.
     */
     ...
     *
     * @throws IllegalStateException if the current variant is not the {@code length} kind.
     */
     ...
     *
     * @throws IllegalStateException if the current variant is not the {@code limit} kind.
     */
     ...
     *
     * @throws IllegalStateException if the current variant is not the {@code multiplexer} kind.
     */
     ...
     *
     * @throws IllegalStateException if the current variant is not the {@code nori_part_of_speech} kind.
     */
     ...
     *
     * @throws IllegalStateException if the current variant is not the {@code pattern_capture} kind.
     */
     ...
     *
     * @throws IllegalStateException if the current variant is not the {@code persian_stem} kind.
     */
     ...
     *
     * @throws IllegalStateException if the current variant is not the {@code phonetic} kind.
     */
     ...
     *
     * @throws IllegalStateException if the current variant is not the {@code porter_stem} kind.
     */
     ...
     *
     * @throws IllegalStateException if the current variant is not the {@code predicate_token_filter} kind.
     */
     ...
     *
     * @throws IllegalStateException if the current variant is not the {@code remove_duplicates} kind.
     */
     ...
     *
     * @throws IllegalStateException if the current variant is not the {@code reverse} kind.
     */
     ...
     *
     * @throws IllegalStateException if the current variant is not the {@code shingle} kind.
     */
    ...
    /**
     * Is this variant instance of kind {@code smartcn_stop}?
     */
    public boolean isSmartcnStop() {
        return _kind == Kind.SmartcnStop;
    }

    /**
     * Get the {@code smartcn_stop} variant value.
     *
     * @throws IllegalStateException if the current variant is not the {@code smartcn_stop} kind.
     */
    public SmartcnStopTokenFilter smartcnStop() {
        return TaggedUnionUtils.get(this, Kind.SmartcnStop);
    }
     ...
     *
     * @throws IllegalStateException if the current variant is not the {@code stemmer} kind.
     */
     ...
     *
     * @throws IllegalStateException if the current variant is not the {@code stemmer_override} kind.
     */
     ...
     *
     * @throws IllegalStateException if the current variant is not the {@code synonym} kind.
     */
     ...
     *
     * @throws IllegalStateException if the current variant is not the {@code synonym_graph} kind.
     */
     ...
     *
     * @throws IllegalStateException if the current variant is not the {@code trim} kind.
     */
     ...
     *
     * @throws IllegalStateException if the current variant is not the {@code truncate} kind.
     */
     ...
     *
     * @throws IllegalStateException if the current variant is not the {@code unique} kind.
     */
     ...
     *
     * @throws IllegalStateException if the current variant is not the {@code uppercase} kind.
     */
     ...
     *
     * @throws IllegalStateException if the current variant is not the {@code word_delimiter} kind.
     */
     ...
     *
     * @throws IllegalStateException if the current variant is not the {@code word_delimiter_graph} kind.
     */
    ...
    public static class Builder extends ObjectBuilderBase implements ObjectBuilder<TokenFilterDefinition> {
        ...
        public ObjectBuilder<TokenFilterDefinition> smartcnStop(SmartcnStopTokenFilter v) {
            this._kind = Kind.SmartcnStop;
            this._value = v;
            return this;
        }

        public ObjectBuilder<TokenFilterDefinition> smartcnStop(
            Function<SmartcnStopTokenFilter.Builder, ObjectBuilder<SmartcnStopTokenFilter>> fn
        ) {
            return this.smartcnStop(fn.apply(new SmartcnStopTokenFilter.Builder()).build());
        }
    ...
    protected static void setupTokenFilterDefinitionDeserializer(ObjectDeserializer<Builder> op) {
        ...
        op.add(Builder::smartcnStop, SmartcnStopTokenFilter._DESERIALIZER, "smartcn_stop");
    ...
    public static final JsonpDeserializer<TokenFilterDefinition> _DESERIALIZER = ObjectBuilderDeserializer.lazy(
        Builder::new,
        TokenFilterDefinition::setupTokenFilterDefinitionDeserializer,
        Builder::build
    );
