...
// typedef: security.patch_configuration.Request
...
public final class PatchConfigurationRequest extends RequestBase
    implements
        PlainJsonSerializable,
        ToCopyableBuilder<PatchConfigurationRequest.Builder, PatchConfigurationRequest> {
    ...
    /**
     * Builder for {@link PatchConfigurationRequest}.
     */
    public static class Builder extends RequestBase.AbstractBuilder<Builder>
        implements
            CopyableBuilder<Builder, PatchConfigurationRequest> {
        private List<PatchOperation> operations;

        public Builder() {}

        private Builder(PatchConfigurationRequest o) {
            super(o);
        ...
        /**
         * Builds a {@link PatchConfigurationRequest}.
         *
    ...
    public static final JsonpDeserializer<PatchConfigurationRequest> _DESERIALIZER = createPatchConfigurationRequestDeserializer();
    ...
    /**
     * Endpoint "{@code security.patch_configuration}".
     */
    public static final Endpoint<PatchConfigurationRequest, PatchConfigurationResponse, ErrorResponse> _ENDPOINT = new SimpleEndpoint<>(
        // Request method
        request -> "PATCH",
        // Request path
        request -> "/_plugins/_security/api/securityconfig",
        // Request parameters
        request -> {
        ...
        true,
        PatchConfigurationResponse._DESERIALIZER
    );
