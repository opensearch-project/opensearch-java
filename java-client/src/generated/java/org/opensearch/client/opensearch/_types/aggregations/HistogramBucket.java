...
public class HistogramBucket extends MultiBucketBase implements ToCopyableBuilder<HistogramBucket.Builder, HistogramBucket> {
    ...
    public static HistogramBucket of(Function<HistogramBucket.Builder, ObjectBuilder<HistogramBucket>> fn) {
     ...
     */
    public static class Builder extends MultiBucketBase.AbstractBuilder<Builder> implements CopyableBuilder<Builder, HistogramBucket> {
        private Double key;
        @Nullable
        ...
        private Builder(HistogramBucket o) {
            super(o);
            this.key = o.key;
    ...
    public boolean equals(Object o) {
        ...
        HistogramBucket other = (HistogramBucket) o;
