...
public class OpenSearchMlClient extends ApiClient<OpenSearchTransport, OpenSearchMlClient> {
     ...
     */
    public ExecuteAlgorithmResponse executeAlgorithm(ExecuteAlgorithmRequest request) throws IOException, OpenSearchException {
        return this.transport.performRequest(request, ExecuteAlgorithmRequest._ENDPOINT, this.transportOptions);
    }
     ...
     */
    public final ExecuteAlgorithmResponse executeAlgorithm(
