...
// typedef: ingest.FailProcessor

@JsonpDeserializable
@Generated("org.opensearch.client.codegen.CodeGenerator")
public class FailProcessor extends ProcessorBase implements ProcessorVariant, ToCopyableBuilder<FailProcessor.Builder, FailProcessor> {
    ...
    public static FailProcessor of(Function<FailProcessor.Builder, ObjectBuilder<FailProcessor>> fn) {
    ...
    /**
     * Required - The error message thrown by the processor. Supports template snippets.
     * <p>
     ...
     */
    public static class Builder extends ProcessorBase.AbstractBuilder<Builder> implements CopyableBuilder<Builder, FailProcessor> {
        private String message;

        public Builder() {}

        private Builder(FailProcessor o) {
            super(o);
    ...
    public boolean equals(Object o) {
        ...
        FailProcessor other = (FailProcessor) o;
