...
// typedef: search_relevance.query_sets_search.Response

@JsonpDeserializable
@Generated("org.opensearch.client.codegen.CodeGenerator")
public class QuerySetsSearchResponse<TDocument>
    implements
        PlainJsonSerializable,
        ToCopyableBuilder<QuerySetsSearchResponse.Builder<TDocument>, QuerySetsSearchResponse<TDocument>> {
    ...
    private QuerySetsSearchResponse(Builder<TDocument> builder) {
    ...
    public static <TDocument> QuerySetsSearchResponse<TDocument> of(
        Function<QuerySetsSearchResponse.Builder<TDocument>, ObjectBuilder<QuerySetsSearchResponse<TDocument>>> fn
    ) {
    ...
    /**
     * Builder for {@link QuerySetsSearchResponse}.
     */
    public static class Builder<TDocument> extends ObjectBuilderBase
        implements
            CopyableBuilder<Builder<TDocument>, QuerySetsSearchResponse<TDocument>> {
        @Nullable
        ...
        private Builder(QuerySetsSearchResponse<TDocument> o) {
        ...
        /**
         * Builds a {@link QuerySetsSearchResponse}.
         *
         * @throws NullPointerException if some of the required fields are null.
         */
        @Override
        @Nonnull
        public QuerySetsSearchResponse<TDocument> build() {
            _checkSingleUse();

            return new QuerySetsSearchResponse<>(this);
        }
    }
    ...
    /**
     * Create a JSON deserializer for QuerySetsSearchResponse.
     */
    public static <TDocument> JsonpDeserializer<QuerySetsSearchResponse<TDocument>> createQuerySetsSearchResponseDeserializer(
        JsonpDeserializer<TDocument> tDocumentDeserializer
    ) {
        return ObjectBuilderDeserializer.createForObject(
            Builder<TDocument>::new,
            op -> QuerySetsSearchResponse.setupQuerySetsSearchResponseDeserializer(op, tDocumentDeserializer)
        );
    }

    /**
     * Json deserializer for {@link QuerySetsSearchResponse} based on named deserializers provided by the calling {@code JsonMapper}.
     */
    public static final JsonpDeserializer<QuerySetsSearchResponse<Object>> _DESERIALIZER = createQuerySetsSearchResponseDeserializer(
        new NamedDeserializer<>("org.opensearch.client:Deserializer:search_relevance.query_sets_search.TDocument")
    );

    protected static <TDocument> void setupQuerySetsSearchResponseDeserializer(
        ObjectDeserializer<QuerySetsSearchResponse.Builder<TDocument>> op,
        JsonpDeserializer<TDocument> tDocumentDeserializer
    ) {
    ...
    public boolean equals(Object o) {
        ...
        QuerySetsSearchResponse<?> other = (QuerySetsSearchResponse<?>) o;
