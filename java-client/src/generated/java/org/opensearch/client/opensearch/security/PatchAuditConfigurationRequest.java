...
// typedef: security.patch_audit_configuration.Request
...
public final class PatchAuditConfigurationRequest extends RequestBase
    implements
        PlainJsonSerializable,
        ToCopyableBuilder<PatchAuditConfigurationRequest.Builder, PatchAuditConfigurationRequest> {
    ...
    private PatchAuditConfigurationRequest(Builder builder) {
        super(builder);
        this.operations = ApiTypeHelper.unmodifiableRequired(builder.operations, this, "operations");
    }

    public static PatchAuditConfigurationRequest of(
    ...
    /**
     * Builder for {@link PatchAuditConfigurationRequest}.
     */
    public static class Builder extends RequestBase.AbstractBuilder<Builder>
        implements
            CopyableBuilder<Builder, PatchAuditConfigurationRequest> {
        private List<PatchOperation> operations;

        public Builder() {}

        private Builder(PatchAuditConfigurationRequest o) {
            super(o);
        ...
        /**
         * Builds a {@link PatchAuditConfigurationRequest}.
         *
         * @throws NullPointerException if some of the required fields are null.
         */
        @Override
        @Nonnull
        public PatchAuditConfigurationRequest build() {
            _checkSingleUse();

            return new PatchAuditConfigurationRequest(this);
        }
    }

    // ---------------------------------------------------------------------------------------------

    public static final JsonpDeserializer<PatchAuditConfigurationRequest> _DESERIALIZER =
        createPatchAuditConfigurationRequestDeserializer();

    protected static JsonpDeserializer<PatchAuditConfigurationRequest> createPatchAuditConfigurationRequestDeserializer() {
    ...
    /**
     * Endpoint "{@code security.patch_audit_configuration}".
     */
    public static final Endpoint<PatchAuditConfigurationRequest, PatchAuditConfigurationResponse, ErrorResponse> _ENDPOINT =
        new SimpleEndpoint<>(
            // Request method
            request -> "PATCH",
            // Request path
            ...
            true,
            PatchAuditConfigurationResponse._DESERIALIZER
        );
    ...
    public boolean equals(Object o) {
        ...
        PatchAuditConfigurationRequest other = (PatchAuditConfigurationRequest) o;
