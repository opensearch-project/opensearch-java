...
public class GeoDistanceAggregate<TBucket>
    implements
        AggregateVariant,
        PlainJsonSerializable,
        ToCopyableBuilder<GeoDistanceAggregate.Builder<TBucket>, GeoDistanceAggregate<TBucket>> {
    ...
    private GeoDistanceAggregate(Builder<TBucket> builder) {
        this.buckets = ApiTypeHelper.requireNonNull(builder.buckets, this, "buckets");
        this.meta = ApiTypeHelper.unmodifiable(builder.meta);
    }

    public static <TBucket> GeoDistanceAggregate<TBucket> of(
        Function<GeoDistanceAggregate.Builder<TBucket>, ObjectBuilder<GeoDistanceAggregate<TBucket>>> fn
    ) {
    ...
    public static class Builder<TBucket> extends ObjectBuilderBase
        implements
            CopyableBuilder<Builder<TBucket>, GeoDistanceAggregate<TBucket>> {
        ...
        private Builder(GeoDistanceAggregate<TBucket> o) {
        ...
        @Override
        @Nonnull
        public GeoDistanceAggregate<TBucket> build() {
            _checkSingleUse();
    ...
    /**
     * Create a JSON deserializer for GeoDistanceAggregate.
     */
    public static <TBucket> JsonpDeserializer<GeoDistanceAggregate<TBucket>> createGeoDistanceAggregateDeserializer(
        JsonpDeserializer<TBucket> tBucketDeserializer
    ) {
        return ObjectBuilderDeserializer.createForObject(
            Builder<TBucket>::new,
            op -> GeoDistanceAggregate.setupGeoDistanceAggregateDeserializer(op, tBucketDeserializer)
        );
    }

    protected static <TBucket> void setupGeoDistanceAggregateDeserializer(
        ObjectDeserializer<GeoDistanceAggregate.Builder<TBucket>> op,
        JsonpDeserializer<TBucket> tBucketDeserializer
    ) {
    ...
    public boolean equals(Object o) {
        ...
        GeoDistanceAggregate<?> other = (GeoDistanceAggregate<?>) o;
