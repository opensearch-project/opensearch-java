...
public class PutPipelineResponse extends AcknowledgedResponseBase
    implements
        ToCopyableBuilder<PutPipelineResponse.Builder, PutPipelineResponse> {
    ...
    public static PutPipelineResponse of(Function<PutPipelineResponse.Builder, ObjectBuilder<PutPipelineResponse>> fn) {
    ...
    public static class Builder extends AcknowledgedResponseBase.AbstractBuilder<Builder>
        implements
            CopyableBuilder<Builder, PutPipelineResponse> {

        public Builder() {}

        private Builder(PutPipelineResponse o) {
            super(o);
        }
