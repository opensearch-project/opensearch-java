...
// typedef: security.patch_role_mapping.Request
...
public final class PatchRoleMappingRequest extends RequestBase
    implements
        PlainJsonSerializable,
        ToCopyableBuilder<PatchRoleMappingRequest.Builder, PatchRoleMappingRequest> {
    ...
    private PatchRoleMappingRequest(Builder builder) {
        super(builder);
    ...
    /**
     * Required - The name of the role to update a role mapping for
     * <p>
     * API name: {@code role}
     * </p>
     */
    ...
    /**
     * Builder for {@link PatchRoleMappingRequest}.
     */
    public static class Builder extends RequestBase.AbstractBuilder<Builder> implements CopyableBuilder<Builder, PatchRoleMappingRequest> {
        private List<PatchOperation> operations;
        private String role;

        public Builder() {}

        private Builder(PatchRoleMappingRequest o) {
            super(o);
        ...
        /**
         * Builds a {@link PatchRoleMappingRequest}.
         *
         * @throws NullPointerException if some of the required fields are null.
         */
        @Override
        @Nonnull
        public PatchRoleMappingRequest build() {
            _checkSingleUse();

            return new PatchRoleMappingRequest(this);
        }
    }

    // ---------------------------------------------------------------------------------------------

    public static final JsonpDeserializer<PatchRoleMappingRequest> _DESERIALIZER = createPatchRoleMappingRequestDeserializer();
    ...
    /**
     * Endpoint "{@code security.patch_role_mapping}".
     */
    public static final Endpoint<PatchRoleMappingRequest, PatchRoleMappingResponse, ErrorResponse> _ENDPOINT = new SimpleEndpoint<>(
        // Request method
        request -> "PATCH",
        // Request path
        request -> {
        ...
        true,
        PatchRoleMappingResponse._DESERIALIZER
    );
    ...
    public boolean equals(Object o) {
        ...
        PatchRoleMappingRequest other = (PatchRoleMappingRequest) o;
