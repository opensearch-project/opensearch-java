...
public class IdsQuery extends QueryBase implements QueryVariant, ToCopyableBuilder<IdsQuery.Builder, IdsQuery> {
    ...
    public static IdsQuery of(Function<IdsQuery.Builder, ObjectBuilder<IdsQuery>> fn) {
     ...
     */
    public static class Builder extends QueryBase.AbstractBuilder<Builder> implements CopyableBuilder<Builder, IdsQuery> {
        @Nullable
