...
public class GeoTileGridAggregate
    implements
        ...
        ToCopyableBuilder<GeoTileGridAggregate.Builder, GeoTileGridAggregate> {

    @Nonnull
    private final Buckets<GeoTileGridBucket> buckets;
     ...
     */
    @Nonnull
    public final Buckets<GeoTileGridBucket> buckets() {
        return this.buckets;
    }
     ...
     */
    public static class Builder extends ObjectBuilderBase implements CopyableBuilder<Builder, GeoTileGridAggregate> {
        private Buckets<GeoTileGridBucket> buckets;
        @Nullable
        private Map<String, JsonData> meta;

        public Builder() {}

        private Builder(GeoTileGridAggregate o) {
         ...
         */
        @Nonnull
        public final Builder buckets(Buckets<GeoTileGridBucket> value) {
            this.buckets = value;
            return this;
        }
         ...
         */
        @Nonnull
        public final Builder buckets(Function<Buckets.Builder<GeoTileGridBucket>, ObjectBuilder<Buckets<GeoTileGridBucket>>> fn) {
            return buckets(fn.apply(new Buckets.Builder<GeoTileGridBucket>()).build());
        }
    ...
    protected static void setupGeoTileGridAggregateDeserializer(ObjectDeserializer<GeoTileGridAggregate.Builder> op) {
        op.add(Builder::buckets, Buckets.createBucketsDeserializer(GeoTileGridBucket._DESERIALIZER), "buckets");
