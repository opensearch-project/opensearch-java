...
// typedef: ingest.UrlDecodeProcessor

@JsonpDeserializable
@Generated("org.opensearch.client.codegen.CodeGenerator")
public class UrlDecodeProcessor extends ProcessorBase
    implements
        ProcessorVariant,
        ToCopyableBuilder<UrlDecodeProcessor.Builder, UrlDecodeProcessor> {
    ...
    public static UrlDecodeProcessor of(Function<UrlDecodeProcessor.Builder, ObjectBuilder<UrlDecodeProcessor>> fn) {
     ...
     */
    public static class Builder extends ProcessorBase.AbstractBuilder<Builder> implements CopyableBuilder<Builder, UrlDecodeProcessor> {
        ...
        private Builder(UrlDecodeProcessor o) {
            super(o);
            this.field = o.field;
     ...
     */
    public static final JsonpDeserializer<UrlDecodeProcessor> _DESERIALIZER = ObjectBuilderDeserializer.lazy(
        Builder::new,
        UrlDecodeProcessor::setupUrlDecodeProcessorDeserializer
    );
    ...
    public boolean equals(Object o) {
        ...
        UrlDecodeProcessor other = (UrlDecodeProcessor) o;
