...
// typedef: security.update_configuration.Response
...
public class UpdateConfigurationResponse
    ...
    public static UpdateConfigurationResponse of(
        Function<UpdateConfigurationResponse.Builder, ObjectBuilder<UpdateConfigurationResponse>> fn
    ) {
     ...
     */
    public static class Builder extends ObjectBuilderBase implements CopyableBuilder<Builder, UpdateConfigurationResponse> {
        @Nullable
        ...
        private Builder(UpdateConfigurationResponse o) {
     ...
     */
    public static final JsonpDeserializer<UpdateConfigurationResponse> _DESERIALIZER = ObjectBuilderDeserializer.lazy(
        Builder::new,
        UpdateConfigurationResponse::setupUpdateConfigurationResponseDeserializer
    );
