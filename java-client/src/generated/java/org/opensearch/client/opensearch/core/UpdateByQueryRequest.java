...
public final class UpdateByQueryRequest extends RequestBase
    implements
        PlainJsonSerializable,
        ToCopyableBuilder<UpdateByQueryRequest.Builder, UpdateByQueryRequest> {
    ...
    /**
     * ID of the pipeline to use to preprocess incoming documents. If the index has a default ingest pipeline specified, then setting the
     * value to <code>_none</code> disables the default ingest pipeline for this request. If a final pipeline is configured it will always
     * run, regardless of the value of this parameter.
     * <p>
    ...
    /**
     * If <code>true</code>, OpenSearch refreshes affected shards to make the operation visible to search.
     * <p>
     ...
     */
    public static class Builder extends RequestBase.AbstractBuilder<Builder> implements CopyableBuilder<Builder, UpdateByQueryRequest> {
        @Nullable
        ...
        /**
         * ID of the pipeline to use to preprocess incoming documents. If the index has a default ingest pipeline specified, then setting
         * the value to <code>_none</code> disables the default ingest pipeline for this request. If a final pipeline is configured it will
         * always run, regardless of the value of this parameter.
         * <p>
         * API name: {@code pipeline}
         * </p>
         */
     ...
     */
    public static final JsonpDeserializer<UpdateByQueryRequest> _DESERIALIZER = ObjectBuilderDeserializer.lazy(
        Builder::new,
        UpdateByQueryRequest::setupUpdateByQueryRequestDeserializer
    );
    ...
    public static final Endpoint<UpdateByQueryRequest, UpdateByQueryResponse, ErrorResponse> _ENDPOINT = new SimpleEndpoint<>(
        ...
        true,
        UpdateByQueryResponse._DESERIALIZER
    );
