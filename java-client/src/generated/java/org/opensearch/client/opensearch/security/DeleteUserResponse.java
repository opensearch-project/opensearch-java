...
public class DeleteUserResponse implements PlainJsonSerializable, ToCopyableBuilder<DeleteUserResponse.Builder, DeleteUserResponse> {
     ...
     */
    public static class Builder extends ObjectBuilderBase implements CopyableBuilder<Builder, DeleteUserResponse> {
        @Nullable
        ...
        private Builder(DeleteUserResponse o) {
     ...
     */
    public static final JsonpDeserializer<DeleteUserResponse> _DESERIALIZER = ObjectBuilderDeserializer.lazy(
        Builder::new,
        DeleteUserResponse::setupDeleteUserResponseDeserializer
    );
