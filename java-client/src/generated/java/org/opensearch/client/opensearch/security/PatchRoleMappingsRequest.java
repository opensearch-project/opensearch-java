...
// typedef: security.patch_role_mappings.Request
...
public final class PatchRoleMappingsRequest extends RequestBase
    implements
        PlainJsonSerializable,
        ToCopyableBuilder<PatchRoleMappingsRequest.Builder, PatchRoleMappingsRequest> {
    ...
    private PatchRoleMappingsRequest(Builder builder) {
        super(builder);
    ...
    /**
     * Builder for {@link PatchRoleMappingsRequest}.
     */
    public static class Builder extends RequestBase.AbstractBuilder<Builder> implements CopyableBuilder<Builder, PatchRoleMappingsRequest> {
        private List<PatchOperation> operations;

        public Builder() {}

        private Builder(PatchRoleMappingsRequest o) {
            super(o);
        ...
        /**
         * Builds a {@link PatchRoleMappingsRequest}.
         *
         * @throws NullPointerException if some of the required fields are null.
         */
        @Override
        @Nonnull
        public PatchRoleMappingsRequest build() {
            _checkSingleUse();

            return new PatchRoleMappingsRequest(this);
        }
    }

    // ---------------------------------------------------------------------------------------------

    public static final JsonpDeserializer<PatchRoleMappingsRequest> _DESERIALIZER = createPatchRoleMappingsRequestDeserializer();
    ...
    /**
     * Endpoint "{@code security.patch_role_mappings}".
     */
    public static final Endpoint<PatchRoleMappingsRequest, PatchRoleMappingsResponse, ErrorResponse> _ENDPOINT = new SimpleEndpoint<>(
        // Request method
        request -> "PATCH",
        // Request path
        request -> "/_plugins/_security/api/rolesmapping",
        // Request parameters
        request -> {
        ...
        true,
        PatchRoleMappingsResponse._DESERIALIZER
    );
    ...
    public boolean equals(Object o) {
        ...
        PatchRoleMappingsRequest other = (PatchRoleMappingsRequest) o;
