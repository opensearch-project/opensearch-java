...
/**
 * Result of a <code>rare_terms</code> aggregation when the field is unmapped. <code>buckets</code> is always empty.
 */
@JsonpDeserializable
@Generated("org.opensearch.client.codegen.CodeGenerator")
public class UnmappedRareTermsAggregate extends MultiBucketAggregateBase<Void>
    implements
        AggregateVariant,
        ToCopyableBuilder<UnmappedRareTermsAggregate.Builder, UnmappedRareTermsAggregate> {
    ...
    public static UnmappedRareTermsAggregate of(
    ...
    public static class Builder extends MultiBucketAggregateBase.AbstractBuilder<Void, Builder>
        implements
            CopyableBuilder<Builder, UnmappedRareTermsAggregate> {

        public Builder() {}

        private Builder(UnmappedRareTermsAggregate o) {
            super(o);
        }
