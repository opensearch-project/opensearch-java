...
public class DeleteRoleResponse implements PlainJsonSerializable, ToCopyableBuilder<DeleteRoleResponse.Builder, DeleteRoleResponse> {
     ...
     */
    public static class Builder extends ObjectBuilderBase implements CopyableBuilder<Builder, DeleteRoleResponse> {
        @Nullable
        ...
        private Builder(DeleteRoleResponse o) {
     ...
     */
    public static final JsonpDeserializer<DeleteRoleResponse> _DESERIALIZER = ObjectBuilderDeserializer.lazy(
        Builder::new,
        DeleteRoleResponse::setupDeleteRoleResponseDeserializer
    );
