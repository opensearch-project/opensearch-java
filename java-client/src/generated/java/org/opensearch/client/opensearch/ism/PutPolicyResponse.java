...
// typedef: ism.put_policy.Response

@JsonpDeserializable
@Generated("org.opensearch.client.codegen.CodeGenerator")
public class PutPolicyResponse extends Metadata implements ToCopyableBuilder<PutPolicyResponse.Builder, PutPolicyResponse> {
    ...
    public static PutPolicyResponse of(Function<PutPolicyResponse.Builder, ObjectBuilder<PutPolicyResponse>> fn) {
     ...
     */
    public static class Builder extends Metadata.AbstractBuilder<Builder> implements CopyableBuilder<Builder, PutPolicyResponse> {
        @Nullable
        private PolicyEnvelope policy;

        public Builder() {}

        private Builder(PutPolicyResponse o) {
            super(o);
     ...
     */
    public static final JsonpDeserializer<PutPolicyResponse> _DESERIALIZER = ObjectBuilderDeserializer.lazy(
        Builder::new,
        PutPolicyResponse::setupPutPolicyResponseDeserializer
    );
