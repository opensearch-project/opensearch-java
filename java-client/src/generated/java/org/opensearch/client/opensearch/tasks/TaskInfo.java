...
public class TaskInfo extends TaskInfoBase implements ToCopyableBuilder<TaskInfo.Builder, TaskInfo> {
     ...
     */
    public static class Builder extends TaskInfoBase.AbstractBuilder<Builder> implements CopyableBuilder<Builder, TaskInfo> {

        public Builder() {}

        private Builder(TaskInfo o) {
            super(o);
        }
