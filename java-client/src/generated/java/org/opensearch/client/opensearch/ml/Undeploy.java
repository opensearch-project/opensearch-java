...
public class Undeploy implements PlainJsonSerializable, ToCopyableBuilder<Undeploy.Builder, Undeploy> {
    ...
    public static Undeploy of(Function<Undeploy.Builder, ObjectBuilder<Undeploy>> fn) {
    ...
    /**
     * Builder for {@link Undeploy}.
     */
    public static class Builder extends ObjectBuilderBase implements CopyableBuilder<Builder, Undeploy> {
        @Nullable
    ...
    /**
     * Json deserializer for {@link Undeploy}
     */
    public static final JsonpDeserializer<Undeploy> _DESERIALIZER = ObjectBuilderDeserializer.lazy(
        Builder::new,
        Undeploy::setupUndeployDeserializer
    );

    protected static void setupUndeployDeserializer(ObjectDeserializer<Undeploy.Builder> op) {
