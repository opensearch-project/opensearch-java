...
public final class DeleteRoleRequest extends RequestBase implements ToCopyableBuilder<DeleteRoleRequest.Builder, DeleteRoleRequest> {
     ...
     */
    public static class Builder extends RequestBase.AbstractBuilder<Builder> implements CopyableBuilder<Builder, DeleteRoleRequest> {
        private String role;

        public Builder() {}

        private Builder(DeleteRoleRequest o) {
            super(o);
            this.role = o.role;
        }
    ...
    public static final Endpoint<DeleteRoleRequest, DeleteRoleResponse, ErrorResponse> _ENDPOINT = new SimpleEndpoint<>(
        ...
        false,
        DeleteRoleResponse._DESERIALIZER
    );
