...
// typedef: security.patch_roles.Request
...
public final class PatchRolesRequest extends RequestBase
    implements
        PlainJsonSerializable,
        ToCopyableBuilder<PatchRolesRequest.Builder, PatchRolesRequest> {
    ...
    private PatchRolesRequest(Builder builder) {
        super(builder);
        this.operations = ApiTypeHelper.unmodifiableRequired(builder.operations, this, "operations");
    }

    public static PatchRolesRequest of(Function<PatchRolesRequest.Builder, ObjectBuilder<PatchRolesRequest>> fn) {
    ...
    /**
     * Builder for {@link PatchRolesRequest}.
     */
    public static class Builder extends RequestBase.AbstractBuilder<Builder> implements CopyableBuilder<Builder, PatchRolesRequest> {
        private List<PatchOperation> operations;

        public Builder() {}

        private Builder(PatchRolesRequest o) {
            super(o);
        ...
        /**
         * Builds a {@link PatchRolesRequest}.
         *
         * @throws NullPointerException if some of the required fields are null.
         */
        @Override
        @Nonnull
        public PatchRolesRequest build() {
            _checkSingleUse();

            return new PatchRolesRequest(this);
        }
    }

    // ---------------------------------------------------------------------------------------------

    public static final JsonpDeserializer<PatchRolesRequest> _DESERIALIZER = createPatchRolesRequestDeserializer();

    protected static JsonpDeserializer<PatchRolesRequest> createPatchRolesRequestDeserializer() {
    ...
    /**
     * Endpoint "{@code security.patch_roles}".
     */
    public static final Endpoint<PatchRolesRequest, PatchRolesResponse, ErrorResponse> _ENDPOINT = new SimpleEndpoint<>(
        // Request method
        request -> "PATCH",
        // Request path
        request -> "/_plugins/_security/api/roles",
        // Request parameters
        request -> {
        ...
        true,
        PatchRolesResponse._DESERIALIZER
    );
    ...
    public boolean equals(Object o) {
        ...
        PatchRolesRequest other = (PatchRolesRequest) o;
