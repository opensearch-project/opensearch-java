...
// typedef: ltr.clear_cache.Response

@JsonpDeserializable
@Generated("org.opensearch.client.codegen.CodeGenerator")
public class ClearCacheResponse implements PlainJsonSerializable, ToCopyableBuilder<ClearCacheResponse.Builder, ClearCacheResponse> {
    ...
    public static ClearCacheResponse of(Function<ClearCacheResponse.Builder, ObjectBuilder<ClearCacheResponse>> fn) {
     ...
     */
    public static class Builder extends ObjectBuilderBase implements CopyableBuilder<Builder, ClearCacheResponse> {
        @Nullable
        ...
        private Builder(ClearCacheResponse o) {
     ...
     */
    public static final JsonpDeserializer<ClearCacheResponse> _DESERIALIZER = ObjectBuilderDeserializer.lazy(
        Builder::new,
        ClearCacheResponse::setupClearCacheResponseDeserializer
    );
    ...
    public boolean equals(Object o) {
        ...
        ClearCacheResponse other = (ClearCacheResponse) o;
