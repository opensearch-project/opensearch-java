...
public class ErrorCause implements JsonpSerializable {
    ...
    @Nullable private final ErrorCause causedBy;
    ...
    /**
     * The server stack trace. Present only if the `error_trace=true` parameter was sent with the
     * request.
     *
     * <p>API name: {@code stack_trace}
     */
    @Nullable
    ...
    public static class Builder extends ObjectBuilderBase implements ObjectBuilder<ErrorCause> {
        ...
        @Nullable private List<ErrorCause> rootCause;
         ...
         * API name: {@code root_cause}
         *
         * <p>Adds all elements of <code>list</code> to <code>rootCause</code>.
         */
         ...
         * API name: {@code root_cause}
         *
         * <p>Adds one or more values to <code>rootCause</code>.
         */
        ...
        /**
         * The server stack trace. Present only if the `error_trace=true` parameter was sent with
         * the request.
         *
         * <p>API name: {@code stack_trace}
         */
         ...
         * API name: {@code suppressed}
         *
         * <p>Adds all elements of <code>list</code> to <code>suppressed</code>.
         */
         ...
         * API name: {@code suppressed}
         *
         * <p>Adds one or more values to <code>suppressed</code>.
         */
