...
// typedef: search_relevance.search_configurations_search.Response

@JsonpDeserializable
@Generated("org.opensearch.client.codegen.CodeGenerator")
public class SearchConfigurationsSearchResponse<TDocument>
    implements
        PlainJsonSerializable,
        ToCopyableBuilder<SearchConfigurationsSearchResponse.Builder<TDocument>, SearchConfigurationsSearchResponse<TDocument>> {
    ...
    private SearchConfigurationsSearchResponse(Builder<TDocument> builder) {
    ...
    public static <TDocument> SearchConfigurationsSearchResponse<TDocument> of(
        Function<SearchConfigurationsSearchResponse.Builder<TDocument>, ObjectBuilder<SearchConfigurationsSearchResponse<TDocument>>> fn
    ) {
    ...
    /**
     * Builder for {@link SearchConfigurationsSearchResponse}.
     */
    public static class Builder<TDocument> extends ObjectBuilderBase
        implements
            CopyableBuilder<Builder<TDocument>, SearchConfigurationsSearchResponse<TDocument>> {
        @Nullable
        ...
        private Builder(SearchConfigurationsSearchResponse<TDocument> o) {
        ...
        /**
         * Builds a {@link SearchConfigurationsSearchResponse}.
         *
         * @throws NullPointerException if some of the required fields are null.
         */
        @Override
        @Nonnull
        public SearchConfigurationsSearchResponse<TDocument> build() {
            _checkSingleUse();

            return new SearchConfigurationsSearchResponse<>(this);
        }
    }
    ...
    /**
     * Create a JSON deserializer for SearchConfigurationsSearchResponse.
     */
    public static <
        TDocument> JsonpDeserializer<SearchConfigurationsSearchResponse<TDocument>> createSearchConfigurationsSearchResponseDeserializer(
            JsonpDeserializer<TDocument> tDocumentDeserializer
        ) {
        return ObjectBuilderDeserializer.createForObject(
            Builder<TDocument>::new,
            op -> SearchConfigurationsSearchResponse.setupSearchConfigurationsSearchResponseDeserializer(op, tDocumentDeserializer)
        );
    }

    /**
     * Json deserializer for {@link SearchConfigurationsSearchResponse} based on named deserializers provided by the calling
     * {@code JsonMapper}.
     */
    public static final JsonpDeserializer<SearchConfigurationsSearchResponse<Object>> _DESERIALIZER =
        createSearchConfigurationsSearchResponseDeserializer(
            new NamedDeserializer<>("org.opensearch.client:Deserializer:search_relevance.search_configurations_search.TDocument")
        );

    protected static <TDocument> void setupSearchConfigurationsSearchResponseDeserializer(
        ObjectDeserializer<SearchConfigurationsSearchResponse.Builder<TDocument>> op,
        JsonpDeserializer<TDocument> tDocumentDeserializer
    ) {
    ...
    public boolean equals(Object o) {
        ...
        SearchConfigurationsSearchResponse<?> other = (SearchConfigurationsSearchResponse<?>) o;
