...
// typedef: security.validate.Response

@JsonpDeserializable
@Generated("org.opensearch.client.codegen.CodeGenerator")
public class ValidateResponse implements PlainJsonSerializable, ToCopyableBuilder<ValidateResponse.Builder, ValidateResponse> {
    ...
    public static ValidateResponse of(Function<ValidateResponse.Builder, ObjectBuilder<ValidateResponse>> fn) {
     ...
     */
    public static class Builder extends ObjectBuilderBase implements CopyableBuilder<Builder, ValidateResponse> {
        @Nullable
        ...
        private Builder(ValidateResponse o) {
     ...
     */
    public static final JsonpDeserializer<ValidateResponse> _DESERIALIZER = ObjectBuilderDeserializer.lazy(
        Builder::new,
