...
public class ReverseTokenFilter extends TokenFilterBase
    implements
        TokenFilterDefinitionVariant,
        ToCopyableBuilder<ReverseTokenFilter.Builder, ReverseTokenFilter> {
     ...
     */
    public static class Builder extends TokenFilterBase.AbstractBuilder<Builder> implements CopyableBuilder<Builder, ReverseTokenFilter> {

        public Builder() {}

        private Builder(ReverseTokenFilter o) {
            super(o);
        }
     ...
     */
    public static final JsonpDeserializer<ReverseTokenFilter> _DESERIALIZER = ObjectBuilderDeserializer.lazy(
        Builder::new,
        ReverseTokenFilter::setupReverseTokenFilterDeserializer
    );
