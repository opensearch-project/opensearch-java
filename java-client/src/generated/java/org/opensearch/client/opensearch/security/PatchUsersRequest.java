...
// typedef: security.patch_users.Request
...
public final class PatchUsersRequest extends RequestBase
    implements
        PlainJsonSerializable,
        ToCopyableBuilder<PatchUsersRequest.Builder, PatchUsersRequest> {
    ...
    private PatchUsersRequest(Builder builder) {
        super(builder);
        this.operations = ApiTypeHelper.unmodifiableRequired(builder.operations, this, "operations");
    }

    public static PatchUsersRequest of(Function<PatchUsersRequest.Builder, ObjectBuilder<PatchUsersRequest>> fn) {
    ...
    /**
     * Builder for {@link PatchUsersRequest}.
     */
    public static class Builder extends RequestBase.AbstractBuilder<Builder> implements CopyableBuilder<Builder, PatchUsersRequest> {
        private List<PatchOperation> operations;

        public Builder() {}

        private Builder(PatchUsersRequest o) {
            super(o);
        ...
        /**
         * Builds a {@link PatchUsersRequest}.
         *
         * @throws NullPointerException if some of the required fields are null.
         */
        @Override
        @Nonnull
        public PatchUsersRequest build() {
            _checkSingleUse();

            return new PatchUsersRequest(this);
        }
    }

    // ---------------------------------------------------------------------------------------------

    public static final JsonpDeserializer<PatchUsersRequest> _DESERIALIZER = createPatchUsersRequestDeserializer();

    protected static JsonpDeserializer<PatchUsersRequest> createPatchUsersRequestDeserializer() {
    ...
    /**
     * Endpoint "{@code security.patch_users}".
     */
    public static final Endpoint<PatchUsersRequest, PatchUsersResponse, ErrorResponse> _ENDPOINT = new SimpleEndpoint<>(
        // Request method
        request -> "PATCH",
        // Request path
        ...
        true,
        PatchUsersResponse._DESERIALIZER
    );
    ...
    public boolean equals(Object o) {
        ...
        PatchUsersRequest other = (PatchUsersRequest) o;
