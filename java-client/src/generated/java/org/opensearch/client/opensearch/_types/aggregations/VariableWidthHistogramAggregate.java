...
public class VariableWidthHistogramAggregate<TBucket>
    implements
        AggregateVariant,
        PlainJsonSerializable,
        ToCopyableBuilder<VariableWidthHistogramAggregate.Builder<TBucket>, VariableWidthHistogramAggregate<TBucket>> {
    ...
    private VariableWidthHistogramAggregate(Builder<TBucket> builder) {
        this.buckets = ApiTypeHelper.requireNonNull(builder.buckets, this, "buckets");
        this.meta = ApiTypeHelper.unmodifiable(builder.meta);
    }

    public static <TBucket> VariableWidthHistogramAggregate<TBucket> of(
        Function<VariableWidthHistogramAggregate.Builder<TBucket>, ObjectBuilder<VariableWidthHistogramAggregate<TBucket>>> fn
    ) {
    ...
    public static class Builder<TBucket> extends ObjectBuilderBase
        implements
            CopyableBuilder<Builder<TBucket>, VariableWidthHistogramAggregate<TBucket>> {
        ...
        private Builder(VariableWidthHistogramAggregate<TBucket> o) {
        ...
        @Override
        @Nonnull
        public VariableWidthHistogramAggregate<TBucket> build() {
            _checkSingleUse();
    ...
    /**
     * Create a JSON deserializer for VariableWidthHistogramAggregate.
     */
    public static <TBucket> JsonpDeserializer<VariableWidthHistogramAggregate<TBucket>> createVariableWidthHistogramAggregateDeserializer(
        JsonpDeserializer<TBucket> tBucketDeserializer
    ) {
        return ObjectBuilderDeserializer.createForObject(
            Builder<TBucket>::new,
            op -> VariableWidthHistogramAggregate.setupVariableWidthHistogramAggregateDeserializer(op, tBucketDeserializer)
        );
    }

    protected static <TBucket> void setupVariableWidthHistogramAggregateDeserializer(
        ObjectDeserializer<VariableWidthHistogramAggregate.Builder<TBucket>> op,
        JsonpDeserializer<TBucket> tBucketDeserializer
    ) {
