...
public class DeleteRepositoryResponse extends AcknowledgedResponseBase
    ...
    public static DeleteRepositoryResponse of(Function<DeleteRepositoryResponse.Builder, ObjectBuilder<DeleteRepositoryResponse>> fn) {
    ...
    public static class Builder extends AcknowledgedResponseBase.AbstractBuilder<Builder>
        implements
            CopyableBuilder<Builder, DeleteRepositoryResponse> {

        public Builder() {}

        private Builder(DeleteRepositoryResponse o) {
            super(o);
        }
