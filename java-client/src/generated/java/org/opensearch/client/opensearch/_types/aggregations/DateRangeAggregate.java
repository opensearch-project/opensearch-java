...
public class DateRangeAggregate<TBucket>
    implements
        AggregateVariant,
        PlainJsonSerializable,
        ToCopyableBuilder<DateRangeAggregate.Builder<TBucket>, DateRangeAggregate<TBucket>> {
    ...
    private DateRangeAggregate(Builder<TBucket> builder) {
        this.buckets = ApiTypeHelper.requireNonNull(builder.buckets, this, "buckets");
        this.meta = ApiTypeHelper.unmodifiable(builder.meta);
    }

    public static <TBucket> DateRangeAggregate<TBucket> of(
        Function<DateRangeAggregate.Builder<TBucket>, ObjectBuilder<DateRangeAggregate<TBucket>>> fn
    ) {
    ...
    public static class Builder<TBucket> extends ObjectBuilderBase
        implements
            CopyableBuilder<Builder<TBucket>, DateRangeAggregate<TBucket>> {
        ...
        private Builder(DateRangeAggregate<TBucket> o) {
        ...
        @Override
        @Nonnull
        public DateRangeAggregate<TBucket> build() {
            _checkSingleUse();
    ...
    /**
     * Create a JSON deserializer for DateRangeAggregate.
     */
    public static <TBucket> JsonpDeserializer<DateRangeAggregate<TBucket>> createDateRangeAggregateDeserializer(
        JsonpDeserializer<TBucket> tBucketDeserializer
    ) {
        return ObjectBuilderDeserializer.createForObject(
            Builder<TBucket>::new,
            op -> DateRangeAggregate.setupDateRangeAggregateDeserializer(op, tBucketDeserializer)
        );
    }

    protected static <TBucket> void setupDateRangeAggregateDeserializer(
        ObjectDeserializer<DateRangeAggregate.Builder<TBucket>> op,
        JsonpDeserializer<TBucket> tBucketDeserializer
    ) {
    ...
    public boolean equals(Object o) {
        ...
        DateRangeAggregate<?> other = (DateRangeAggregate<?>) o;
