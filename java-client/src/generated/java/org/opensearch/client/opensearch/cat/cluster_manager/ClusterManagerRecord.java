...
public class ClusterManagerRecord implements PlainJsonSerializable, ToCopyableBuilder<ClusterManagerRecord.Builder, ClusterManagerRecord> {
    ...
    public static ClusterManagerRecord of(Function<ClusterManagerRecord.Builder, ObjectBuilder<ClusterManagerRecord>> fn) {
     ...
     */
    public static class Builder extends ObjectBuilderBase implements CopyableBuilder<Builder, ClusterManagerRecord> {
        @Nullable
        private String host;
        @Nullable
        private String id;
        ...
        private Builder(ClusterManagerRecord o) {
            this.host = o.host;
            this.id = o.id;
            this.ip = o.ip;
            this.node = o.node;
    ...
    public boolean equals(Object o) {
        ...
        ClusterManagerRecord other = (ClusterManagerRecord) o;
