...
public class MemoryStats implements PlainJsonSerializable, ToCopyableBuilder<MemoryStats.Builder, MemoryStats> {
    ...
    public static MemoryStats memoryStatsOf(Function<MemoryStats.Builder, ObjectBuilder<MemoryStats>> fn) {
    ...
    @Nonnull
    public static Builder memoryStatsBuilder() {
        return new Builder();
    }
     ...
     */
    public static class Builder extends MemoryStats.AbstractBuilder<Builder> implements CopyableBuilder<Builder, MemoryStats> {
        public Builder() {}
    ...
    protected abstract static class AbstractBuilder<BuilderT extends AbstractBuilder<BuilderT>> extends ObjectBuilderBase {
        ...
        protected AbstractBuilder(MemoryStats o) {
            this.free = o.free;
