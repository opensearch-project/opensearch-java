...
// typedef: indices.IndexRoutingAllocationInitialRecovery
...
public class IndexRoutingAllocationInitialRecovery
    implements
        ...
        ToCopyableBuilder<IndexRoutingAllocationInitialRecovery.Builder, IndexRoutingAllocationInitialRecovery> {
     ...
     */
    public static class Builder extends ObjectBuilderBase implements CopyableBuilder<Builder, IndexRoutingAllocationInitialRecovery> {
        @Nullable
        private String id;

        public Builder() {}

        private Builder(IndexRoutingAllocationInitialRecovery o) {
            this.id = o.id;
        }
    ...
    public boolean equals(Object o) {
        ...
        IndexRoutingAllocationInitialRecovery other = (IndexRoutingAllocationInitialRecovery) o;
