...
public final class GetUserRequest extends RequestBase implements ToCopyableBuilder<GetUserRequest.Builder, GetUserRequest> {
    ...
    public static GetUserRequest of(Function<GetUserRequest.Builder, ObjectBuilder<GetUserRequest>> fn) {
     ...
     */
    public static class Builder extends RequestBase.AbstractBuilder<Builder> implements CopyableBuilder<Builder, GetUserRequest> {
        private String username;

        public Builder() {}

        private Builder(GetUserRequest o) {
            super(o);
