...
// typedef: security.post_dashboards_info.Response
...
public class PostDashboardsInfoResponse
    implements
        ...
        ToCopyableBuilder<PostDashboardsInfoResponse.Builder, PostDashboardsInfoResponse> {
    ...
    private PostDashboardsInfoResponse(Builder builder) {
    ...
    public static PostDashboardsInfoResponse of(
        Function<PostDashboardsInfoResponse.Builder, ObjectBuilder<PostDashboardsInfoResponse>> fn
    ) {
    ...
    /**
     * Builder for {@link PostDashboardsInfoResponse}.
     */
    public static class Builder extends ObjectBuilderBase implements CopyableBuilder<Builder, PostDashboardsInfoResponse> {
        @Nullable
        ...
        private Builder(PostDashboardsInfoResponse o) {
        ...
        /**
         * Builds a {@link PostDashboardsInfoResponse}.
         *
         * @throws NullPointerException if some of the required fields are null.
         */
        @Override
        @Nonnull
        public PostDashboardsInfoResponse build() {
            _checkSingleUse();

            return new PostDashboardsInfoResponse(this);
        }
    }
    ...
    /**
     * Json deserializer for {@link PostDashboardsInfoResponse}
     */
    public static final JsonpDeserializer<PostDashboardsInfoResponse> _DESERIALIZER = ObjectBuilderDeserializer.lazy(
        Builder::new,
        PostDashboardsInfoResponse::setupPostDashboardsInfoResponseDeserializer
    );
    ...
    public boolean equals(Object o) {
        ...
        PostDashboardsInfoResponse other = (PostDashboardsInfoResponse) o;
