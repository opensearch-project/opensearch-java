...
public class NodeattrsResponse implements PlainJsonSerializable, ToCopyableBuilder<NodeattrsResponse.Builder, NodeattrsResponse> {
    ...
    public static NodeattrsResponse of(Function<NodeattrsResponse.Builder, ObjectBuilder<NodeattrsResponse>> fn) {
     ...
     */
    public static class Builder extends ObjectBuilderBase implements CopyableBuilder<Builder, NodeattrsResponse> {
        private List<NodeAttributesRecord> valueBody;

        public Builder() {}

        private Builder(NodeattrsResponse o) {
    ...
    protected static JsonpDeserializer<NodeattrsResponse> createNodeattrsResponseDeserializer() {
        JsonpDeserializer<List<NodeAttributesRecord>> valueDeserializer = JsonpDeserializer.arrayDeserializer(
            NodeAttributesRecord._DESERIALIZER
        );
