...
public class NodeInfoIngestProcessor
    implements
        ...
        ToCopyableBuilder<NodeInfoIngestProcessor.Builder, NodeInfoIngestProcessor> {
     ...
     */
    public static class Builder extends ObjectBuilderBase implements CopyableBuilder<Builder, NodeInfoIngestProcessor> {
        private String type;

        public Builder() {}

        private Builder(NodeInfoIngestProcessor o) {
            this.type = o.type;
        }
    ...
    public boolean equals(Object o) {
        ...
        NodeInfoIngestProcessor other = (NodeInfoIngestProcessor) o;
