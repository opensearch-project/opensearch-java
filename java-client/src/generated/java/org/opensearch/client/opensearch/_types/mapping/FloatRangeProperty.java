...
public class FloatRangeProperty extends RangePropertyBase
    implements
        PropertyVariant,
        ToCopyableBuilder<FloatRangeProperty.Builder, FloatRangeProperty> {
     ...
     */
    public static class Builder extends RangePropertyBase.AbstractBuilder<Builder> implements CopyableBuilder<Builder, FloatRangeProperty> {

        public Builder() {}

        private Builder(FloatRangeProperty o) {
            super(o);
        }
