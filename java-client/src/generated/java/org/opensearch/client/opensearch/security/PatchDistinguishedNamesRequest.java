...
// typedef: security.patch_distinguished_names.Request
...
public final class PatchDistinguishedNamesRequest extends RequestBase
    implements
        PlainJsonSerializable,
        ToCopyableBuilder<PatchDistinguishedNamesRequest.Builder, PatchDistinguishedNamesRequest> {
    ...
    private PatchDistinguishedNamesRequest(Builder builder) {
        super(builder);
        this.operations = ApiTypeHelper.unmodifiableRequired(builder.operations, this, "operations");
    }

    public static PatchDistinguishedNamesRequest of(
    ...
    /**
     * Builder for {@link PatchDistinguishedNamesRequest}.
     */
    public static class Builder extends RequestBase.AbstractBuilder<Builder>
        implements
            CopyableBuilder<Builder, PatchDistinguishedNamesRequest> {
        private List<PatchOperation> operations;

        public Builder() {}

        private Builder(PatchDistinguishedNamesRequest o) {
            super(o);
        ...
        /**
         * Builds a {@link PatchDistinguishedNamesRequest}.
         *
         * @throws NullPointerException if some of the required fields are null.
         */
        @Override
        @Nonnull
        public PatchDistinguishedNamesRequest build() {
            _checkSingleUse();

            return new PatchDistinguishedNamesRequest(this);
        }
    }

    // ---------------------------------------------------------------------------------------------

    public static final JsonpDeserializer<PatchDistinguishedNamesRequest> _DESERIALIZER =
        createPatchDistinguishedNamesRequestDeserializer();

    protected static JsonpDeserializer<PatchDistinguishedNamesRequest> createPatchDistinguishedNamesRequestDeserializer() {
    ...
    /**
     * Endpoint "{@code security.patch_distinguished_names}".
     */
    public static final Endpoint<PatchDistinguishedNamesRequest, PatchDistinguishedNamesResponse, ErrorResponse> _ENDPOINT =
        new SimpleEndpoint<>(
            // Request method
            request -> "PATCH",
            // Request path
            ...
            true,
            PatchDistinguishedNamesResponse._DESERIALIZER
        );
    ...
    public boolean equals(Object o) {
        ...
        PatchDistinguishedNamesRequest other = (PatchDistinguishedNamesRequest) o;
