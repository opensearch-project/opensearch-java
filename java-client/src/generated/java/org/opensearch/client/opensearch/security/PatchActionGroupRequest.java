...
// typedef: security.patch_action_group.Request
...
public final class PatchActionGroupRequest extends RequestBase
    implements
        PlainJsonSerializable,
        ToCopyableBuilder<PatchActionGroupRequest.Builder, PatchActionGroupRequest> {
    ...
    public static PatchActionGroupRequest of(Function<PatchActionGroupRequest.Builder, ObjectBuilder<PatchActionGroupRequest>> fn) {
        return fn.apply(new Builder()).build();
    }

    /**
     * Required - The name of the action group to update.
     * <p>
    ...
    /**
     * Builder for {@link PatchActionGroupRequest}.
     */
    public static class Builder extends RequestBase.AbstractBuilder<Builder> implements CopyableBuilder<Builder, PatchActionGroupRequest> {
        ...
        /**
         * Builds a {@link PatchActionGroupRequest}.
         *
    ...
    public static final JsonpDeserializer<PatchActionGroupRequest> _DESERIALIZER = createPatchActionGroupRequestDeserializer();
    ...
    /**
     * Endpoint "{@code security.patch_action_group}".
     */
    public static final Endpoint<PatchActionGroupRequest, PatchActionGroupResponse, ErrorResponse> _ENDPOINT = new SimpleEndpoint<>(
        // Request method
        request -> "PATCH",
        // Request path
        request -> {
        ...
        true,
        PatchActionGroupResponse._DESERIALIZER
    );
