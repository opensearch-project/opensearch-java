...
public class ClusterProcessCpu implements PlainJsonSerializable, ToCopyableBuilder<ClusterProcessCpu.Builder, ClusterProcessCpu> {
    ...
    /**
     * Required - Percentage of CPU used across all selected nodes. Returns <code>-1</code> if not supported.
     * <p>
     ...
     */
    public static class Builder extends ObjectBuilderBase implements CopyableBuilder<Builder, ClusterProcessCpu> {
        private Double percent;

        public Builder() {}

        private Builder(ClusterProcessCpu o) {
    ...
    public boolean equals(Object o) {
        ...
        ClusterProcessCpu other = (ClusterProcessCpu) o;
