...
public class PercolatorProperty extends PropertyBase
    implements
        PropertyVariant,
        ToCopyableBuilder<PercolatorProperty.Builder, PercolatorProperty> {
     ...
     */
    public static class Builder extends PropertyBase.AbstractBuilder<Builder> implements CopyableBuilder<Builder, PercolatorProperty> {

        public Builder() {}

        private Builder(PercolatorProperty o) {
            super(o);
        }
