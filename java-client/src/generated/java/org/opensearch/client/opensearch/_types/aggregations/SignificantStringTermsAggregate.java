...
public class SignificantStringTermsAggregate<TBucket>
    implements
        AggregateVariant,
        PlainJsonSerializable,
        ToCopyableBuilder<SignificantStringTermsAggregate.Builder<TBucket>, SignificantStringTermsAggregate<TBucket>> {
    ...
    private SignificantStringTermsAggregate(Builder<TBucket> builder) {
    ...
    public static <TBucket> SignificantStringTermsAggregate<TBucket> of(
        Function<SignificantStringTermsAggregate.Builder<TBucket>, ObjectBuilder<SignificantStringTermsAggregate<TBucket>>> fn
    ) {
    ...
    public static class Builder<TBucket> extends ObjectBuilderBase
        implements
            CopyableBuilder<Builder<TBucket>, SignificantStringTermsAggregate<TBucket>> {
        @Nullable
        ...
        private Builder(SignificantStringTermsAggregate<TBucket> o) {
        ...
        @Override
        @Nonnull
        public SignificantStringTermsAggregate<TBucket> build() {
            _checkSingleUse();
    ...
    /**
     * Create a JSON deserializer for SignificantStringTermsAggregate.
     */
    public static <TBucket> JsonpDeserializer<SignificantStringTermsAggregate<TBucket>> createSignificantStringTermsAggregateDeserializer(
        JsonpDeserializer<TBucket> tBucketDeserializer
    ) {
        return ObjectBuilderDeserializer.createForObject(
            Builder<TBucket>::new,
            op -> SignificantStringTermsAggregate.setupSignificantStringTermsAggregateDeserializer(op, tBucketDeserializer)
        );
    }

    protected static <TBucket> void setupSignificantStringTermsAggregateDeserializer(
        ObjectDeserializer<SignificantStringTermsAggregate.Builder<TBucket>> op,
        JsonpDeserializer<TBucket> tBucketDeserializer
    ) {
