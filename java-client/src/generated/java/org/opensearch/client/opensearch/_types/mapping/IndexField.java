...
public class IndexField implements PlainJsonSerializable, ToCopyableBuilder<IndexField.Builder, IndexField> {
     ...
     */
    public static class Builder extends ObjectBuilderBase implements CopyableBuilder<Builder, IndexField> {
        private Boolean enabled;

        public Builder() {}

        private Builder(IndexField o) {
