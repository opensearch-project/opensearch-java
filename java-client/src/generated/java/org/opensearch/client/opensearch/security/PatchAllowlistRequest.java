...
// typedef: security.patch_allowlist.Request
...
public final class PatchAllowlistRequest extends RequestBase
    implements
        PlainJsonSerializable,
        ToCopyableBuilder<PatchAllowlistRequest.Builder, PatchAllowlistRequest> {
    ...
    private PatchAllowlistRequest(Builder builder) {
        super(builder);
        this.operations = ApiTypeHelper.unmodifiableRequired(builder.operations, this, "operations");
    }

    public static PatchAllowlistRequest of(Function<PatchAllowlistRequest.Builder, ObjectBuilder<PatchAllowlistRequest>> fn) {
    ...
    /**
     * Builder for {@link PatchAllowlistRequest}.
     */
    public static class Builder extends RequestBase.AbstractBuilder<Builder> implements CopyableBuilder<Builder, PatchAllowlistRequest> {
        private List<PatchOperation> operations;

        public Builder() {}

        private Builder(PatchAllowlistRequest o) {
            super(o);
        ...
        /**
         * Builds a {@link PatchAllowlistRequest}.
         *
         * @throws NullPointerException if some of the required fields are null.
         */
        @Override
        @Nonnull
        public PatchAllowlistRequest build() {
            _checkSingleUse();

            return new PatchAllowlistRequest(this);
        }
    }

    // ---------------------------------------------------------------------------------------------

    public static final JsonpDeserializer<PatchAllowlistRequest> _DESERIALIZER = createPatchAllowlistRequestDeserializer();

    protected static JsonpDeserializer<PatchAllowlistRequest> createPatchAllowlistRequestDeserializer() {
    ...
    /**
     * Endpoint "{@code security.patch_allowlist}".
     */
    public static final Endpoint<PatchAllowlistRequest, PatchAllowlistResponse, ErrorResponse> _ENDPOINT = new SimpleEndpoint<>(
        // Request method
        request -> "PATCH",
        // Request path
        ...
        true,
        PatchAllowlistResponse._DESERIALIZER
    );
    ...
    public boolean equals(Object o) {
        ...
        PatchAllowlistRequest other = (PatchAllowlistRequest) o;
