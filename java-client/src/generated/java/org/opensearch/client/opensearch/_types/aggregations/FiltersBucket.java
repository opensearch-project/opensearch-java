...
public class FiltersBucket extends MultiBucketBase implements ToCopyableBuilder<FiltersBucket.Builder, FiltersBucket> {
    ...
    public static FiltersBucket of(Function<FiltersBucket.Builder, ObjectBuilder<FiltersBucket>> fn) {
     ...
     */
    public static class Builder extends MultiBucketBase.AbstractBuilder<Builder> implements CopyableBuilder<Builder, FiltersBucket> {

        public Builder() {}

        private Builder(FiltersBucket o) {
            super(o);
        }
