...
// typedef: knn.get_model.Response
...
public class GetModelResponse implements PlainJsonSerializable, ToCopyableBuilder<GetModelResponse.Builder, GetModelResponse> {
    ...
    /**
     * Singleton instance for {@link GetModelResponse}.
     */
    public static final GetModelResponse _INSTANCE = builder().build();

    public static final JsonpDeserializer<GetModelResponse> _DESERIALIZER = JsonpDeserializer.emptyObject(GetModelResponse._INSTANCE);
