...
public class AliasesResponse implements JsonpSerializable {
    ...
    * <p>Required - Response value.</p>

    * <p>API name: {@code _value_body}</p>
    */
    ...
    public static class Builder extends ObjectBuilderBase implements ObjectBuilder<AliasesResponse> {
        ...
        * <p>API name: {@code _value_body}</p>
        * <p>Adds all elements of <code>list</code> to <code>valueBody</code>.</p>
        */
        ...
        * <p>API name: {@code _value_body}</p>
        * <p>Adds one or more values to <code>valueBody</code>.</p>
        */
        ...
        * <p>API name: {@code _value_body}</p>
        * <p>Adds a value to <code>valueBody</code> using a builder lambda.</p>
        */
