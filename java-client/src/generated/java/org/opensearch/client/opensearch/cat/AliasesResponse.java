...
public class AliasesResponse implements PlainJsonSerializable, ToCopyableBuilder<AliasesResponse.Builder, AliasesResponse> {
    ...
    public static AliasesResponse of(Function<AliasesResponse.Builder, ObjectBuilder<AliasesResponse>> fn) {
     ...
     */
    public static class Builder extends ObjectBuilderBase implements CopyableBuilder<Builder, AliasesResponse> {
        private List<AliasesRecord> valueBody;

        public Builder() {}

        private Builder(AliasesResponse o) {
    ...
    protected static JsonpDeserializer<AliasesResponse> createAliasesResponseDeserializer() {
        JsonpDeserializer<List<AliasesRecord>> valueDeserializer = JsonpDeserializer.arrayDeserializer(AliasesRecord._DESERIALIZER);
