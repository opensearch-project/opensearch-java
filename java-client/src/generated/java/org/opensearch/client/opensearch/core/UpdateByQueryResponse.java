...
// typedef: update_by_query.Response
...
public class UpdateByQueryResponse
    implements
        ...
        ToCopyableBuilder<UpdateByQueryResponse.Builder, UpdateByQueryResponse> {
     ...
     */
    public static class Builder extends ObjectBuilderBase implements CopyableBuilder<Builder, UpdateByQueryResponse> {
        @Nullable
        ...
        private Builder(UpdateByQueryResponse o) {
     ...
     */
    public static final JsonpDeserializer<UpdateByQueryResponse> _DESERIALIZER = ObjectBuilderDeserializer.lazy(
        Builder::new,
        UpdateByQueryResponse::setupUpdateByQueryResponseDeserializer
    );
    ...
    public boolean equals(Object o) {
        ...
        UpdateByQueryResponse other = (UpdateByQueryResponse) o;
