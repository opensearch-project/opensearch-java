...
// typedef: security.create_allowlist.Response
...
public class CreateAllowlistResponse
    implements
        ...
        ToCopyableBuilder<CreateAllowlistResponse.Builder, CreateAllowlistResponse> {
    ...
    private CreateAllowlistResponse(Builder builder) {
        this.enabled = builder.enabled;
        this.requests = ApiTypeHelper.unmodifiable(builder.requests);
    }

    public static CreateAllowlistResponse of(Function<CreateAllowlistResponse.Builder, ObjectBuilder<CreateAllowlistResponse>> fn) {
    ...
    /**
     * Builder for {@link CreateAllowlistResponse}.
     */
    public static class Builder extends ObjectBuilderBase implements CopyableBuilder<Builder, CreateAllowlistResponse> {
        @Nullable
        ...
        private Builder(CreateAllowlistResponse o) {
        ...
        /**
         * Builds a {@link CreateAllowlistResponse}.
         *
         * @throws NullPointerException if some of the required fields are null.
         */
        @Override
        @Nonnull
        public CreateAllowlistResponse build() {
            _checkSingleUse();

            return new CreateAllowlistResponse(this);
        }
    }
    ...
    /**
     * Json deserializer for {@link CreateAllowlistResponse}
     */
    public static final JsonpDeserializer<CreateAllowlistResponse> _DESERIALIZER = ObjectBuilderDeserializer.lazy(
        Builder::new,
        CreateAllowlistResponse::setupCreateAllowlistResponseDeserializer
    );

    protected static void setupCreateAllowlistResponseDeserializer(ObjectDeserializer<CreateAllowlistResponse.Builder> op) {
    ...
    public boolean equals(Object o) {
        ...
        CreateAllowlistResponse other = (CreateAllowlistResponse) o;
