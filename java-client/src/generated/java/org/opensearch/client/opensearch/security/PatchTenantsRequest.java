...
// typedef: security.patch_tenants.Request
...
public final class PatchTenantsRequest extends RequestBase
    implements
        PlainJsonSerializable,
        ToCopyableBuilder<PatchTenantsRequest.Builder, PatchTenantsRequest> {
    ...
    private PatchTenantsRequest(Builder builder) {
        super(builder);
        this.operations = ApiTypeHelper.unmodifiableRequired(builder.operations, this, "operations");
    }

    public static PatchTenantsRequest of(Function<PatchTenantsRequest.Builder, ObjectBuilder<PatchTenantsRequest>> fn) {
    ...
    /**
     * Builder for {@link PatchTenantsRequest}.
     */
    public static class Builder extends RequestBase.AbstractBuilder<Builder> implements CopyableBuilder<Builder, PatchTenantsRequest> {
        private List<PatchOperation> operations;

        public Builder() {}

        private Builder(PatchTenantsRequest o) {
            super(o);
        ...
        /**
         * Builds a {@link PatchTenantsRequest}.
         *
         * @throws NullPointerException if some of the required fields are null.
         */
        @Override
        @Nonnull
        public PatchTenantsRequest build() {
            _checkSingleUse();

            return new PatchTenantsRequest(this);
        }
    }

    // ---------------------------------------------------------------------------------------------

    public static final JsonpDeserializer<PatchTenantsRequest> _DESERIALIZER = createPatchTenantsRequestDeserializer();

    protected static JsonpDeserializer<PatchTenantsRequest> createPatchTenantsRequestDeserializer() {
    ...
    /**
     * Endpoint "{@code security.patch_tenants}".
     */
    public static final Endpoint<PatchTenantsRequest, PatchTenantsResponse, ErrorResponse> _ENDPOINT = new SimpleEndpoint<>(
        // Request method
        request -> "PATCH",
        // Request path
        request -> "/_plugins/_security/api/tenants",
        // Request parameters
        request -> {
        ...
        true,
        PatchTenantsResponse._DESERIALIZER
    );
    ...
    public boolean equals(Object o) {
        ...
        PatchTenantsRequest other = (PatchTenantsRequest) o;
