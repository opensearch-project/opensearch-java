...
public class FiltersAggregate
    ...
    @Nonnull
    private final Buckets<FiltersBucket> buckets;
     ...
     */
    @Nonnull
    public final Buckets<FiltersBucket> buckets() {
        return this.buckets;
    }
     ...
     */
    public static class Builder extends ObjectBuilderBase implements CopyableBuilder<Builder, FiltersAggregate> {
        private Buckets<FiltersBucket> buckets;
        @Nullable
        private Map<String, JsonData> meta;

        public Builder() {}

        private Builder(FiltersAggregate o) {
         ...
         */
        @Nonnull
        public final Builder buckets(Buckets<FiltersBucket> value) {
            this.buckets = value;
            return this;
        }
         ...
         */
        @Nonnull
        public final Builder buckets(Function<Buckets.Builder<FiltersBucket>, ObjectBuilder<Buckets<FiltersBucket>>> fn) {
            return buckets(fn.apply(new Buckets.Builder<FiltersBucket>()).build());
        }
    ...
    protected static void setupFiltersAggregateDeserializer(ObjectDeserializer<FiltersAggregate.Builder> op) {
        op.add(Builder::buckets, Buckets.createBucketsDeserializer(FiltersBucket._DESERIALIZER), "buckets");
