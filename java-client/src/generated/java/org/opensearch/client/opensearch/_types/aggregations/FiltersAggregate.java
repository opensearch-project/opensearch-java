...
public class FiltersAggregate<TBucket>
    implements
        AggregateVariant,
        PlainJsonSerializable,
        ToCopyableBuilder<FiltersAggregate.Builder<TBucket>, FiltersAggregate<TBucket>> {
    ...
    private FiltersAggregate(Builder<TBucket> builder) {
        this.buckets = ApiTypeHelper.requireNonNull(builder.buckets, this, "buckets");
        this.meta = ApiTypeHelper.unmodifiable(builder.meta);
    }

    public static <TBucket> FiltersAggregate<TBucket> of(
        Function<FiltersAggregate.Builder<TBucket>, ObjectBuilder<FiltersAggregate<TBucket>>> fn
    ) {
     ...
     */
    public static class Builder<TBucket> extends ObjectBuilderBase implements CopyableBuilder<Builder<TBucket>, FiltersAggregate<TBucket>> {
        ...
        private Builder(FiltersAggregate<TBucket> o) {
        ...
        @Override
        @Nonnull
        public FiltersAggregate<TBucket> build() {
            _checkSingleUse();
    ...
    /**
     * Create a JSON deserializer for FiltersAggregate.
     */
    public static <TBucket> JsonpDeserializer<FiltersAggregate<TBucket>> createFiltersAggregateDeserializer(
        JsonpDeserializer<TBucket> tBucketDeserializer
    ) {
        return ObjectBuilderDeserializer.createForObject(
            Builder<TBucket>::new,
            op -> FiltersAggregate.setupFiltersAggregateDeserializer(op, tBucketDeserializer)
        );
    }

    protected static <TBucket> void setupFiltersAggregateDeserializer(
        ObjectDeserializer<FiltersAggregate.Builder<TBucket>> op,
        JsonpDeserializer<TBucket> tBucketDeserializer
    ) {
    ...
    public boolean equals(Object o) {
        ...
        FiltersAggregate<?> other = (FiltersAggregate<?>) o;
