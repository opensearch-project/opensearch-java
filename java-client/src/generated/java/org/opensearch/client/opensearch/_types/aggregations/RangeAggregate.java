...
public class RangeAggregate<TBucket>
    implements
        AggregateVariant,
        PlainJsonSerializable,
        ToCopyableBuilder<RangeAggregate.Builder<TBucket>, RangeAggregate<TBucket>> {
    ...
    private RangeAggregate(Builder<TBucket> builder) {
        this.buckets = ApiTypeHelper.requireNonNull(builder.buckets, this, "buckets");
        this.meta = ApiTypeHelper.unmodifiable(builder.meta);
    }

    public static <TBucket> RangeAggregate<TBucket> of(
        Function<RangeAggregate.Builder<TBucket>, ObjectBuilder<RangeAggregate<TBucket>>> fn
    ) {
     ...
     */
    public static class Builder<TBucket> extends ObjectBuilderBase implements CopyableBuilder<Builder<TBucket>, RangeAggregate<TBucket>> {
        ...
        private Builder(RangeAggregate<TBucket> o) {
        ...
        @Override
        @Nonnull
        public RangeAggregate<TBucket> build() {
            _checkSingleUse();
    ...
    /**
     * Create a JSON deserializer for RangeAggregate.
     */
    public static <TBucket> JsonpDeserializer<RangeAggregate<TBucket>> createRangeAggregateDeserializer(
        JsonpDeserializer<TBucket> tBucketDeserializer
    ) {
        return ObjectBuilderDeserializer.createForObject(
            Builder<TBucket>::new,
            op -> RangeAggregate.setupRangeAggregateDeserializer(op, tBucketDeserializer)
        );
    }

    protected static <TBucket> void setupRangeAggregateDeserializer(
        ObjectDeserializer<RangeAggregate.Builder<TBucket>> op,
        JsonpDeserializer<TBucket> tBucketDeserializer
    ) {
