...
public class UnsignedLongNumberProperty extends NumberPropertyBase
    implements
        PropertyVariant,
        ToCopyableBuilder<UnsignedLongNumberProperty.Builder, UnsignedLongNumberProperty> {
    ...
    public static UnsignedLongNumberProperty of(
    ...
    public static class Builder extends NumberPropertyBase.AbstractBuilder<Builder>
        implements
            CopyableBuilder<Builder, UnsignedLongNumberProperty> {
        @Nullable
        private Number nullValue;

        public Builder() {}

        private Builder(UnsignedLongNumberProperty o) {
            super(o);
    ...
    public static final JsonpDeserializer<UnsignedLongNumberProperty> _DESERIALIZER = ObjectBuilderDeserializer.lazy(
        Builder::new,
        UnsignedLongNumberProperty::setupUnsignedLongNumberPropertyDeserializer
    );

    protected static void setupUnsignedLongNumberPropertyDeserializer(ObjectDeserializer<UnsignedLongNumberProperty.Builder> op) {
    ...
    public boolean equals(Object o) {
        ...
        UnsignedLongNumberProperty other = (UnsignedLongNumberProperty) o;
