...
public class CloseIndexRequest extends RequestBase implements ToCopyableBuilder<CloseIndexRequest.Builder, CloseIndexRequest> {
     ...
     */
    public static class Builder extends ObjectBuilderBase implements CopyableBuilder<Builder, CloseIndexRequest> {
        @Nullable
