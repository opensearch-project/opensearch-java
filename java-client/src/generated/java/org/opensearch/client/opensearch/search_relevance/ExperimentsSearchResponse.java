...
// typedef: search_relevance.experiments_search.Response

@JsonpDeserializable
@Generated("org.opensearch.client.codegen.CodeGenerator")
public class ExperimentsSearchResponse<TDocument>
    implements
        PlainJsonSerializable,
        ToCopyableBuilder<ExperimentsSearchResponse.Builder<TDocument>, ExperimentsSearchResponse<TDocument>> {
    ...
    private ExperimentsSearchResponse(Builder<TDocument> builder) {
    ...
    public static <TDocument> ExperimentsSearchResponse<TDocument> of(
        Function<ExperimentsSearchResponse.Builder<TDocument>, ObjectBuilder<ExperimentsSearchResponse<TDocument>>> fn
    ) {
    ...
    /**
     * Builder for {@link ExperimentsSearchResponse}.
     */
    public static class Builder<TDocument> extends ObjectBuilderBase
        implements
            CopyableBuilder<Builder<TDocument>, ExperimentsSearchResponse<TDocument>> {
        @Nullable
        ...
        private Builder(ExperimentsSearchResponse<TDocument> o) {
        ...
        /**
         * Builds a {@link ExperimentsSearchResponse}.
         *
         * @throws NullPointerException if some of the required fields are null.
         */
        @Override
        @Nonnull
        public ExperimentsSearchResponse<TDocument> build() {
            _checkSingleUse();

            return new ExperimentsSearchResponse<>(this);
        }
    }
    ...
    /**
     * Create a JSON deserializer for ExperimentsSearchResponse.
     */
    public static <TDocument> JsonpDeserializer<ExperimentsSearchResponse<TDocument>> createExperimentsSearchResponseDeserializer(
        JsonpDeserializer<TDocument> tDocumentDeserializer
    ) {
        return ObjectBuilderDeserializer.createForObject(
            Builder<TDocument>::new,
            op -> ExperimentsSearchResponse.setupExperimentsSearchResponseDeserializer(op, tDocumentDeserializer)
        );
    }

    /**
     * Json deserializer for {@link ExperimentsSearchResponse} based on named deserializers provided by the calling {@code JsonMapper}.
     */
    public static final JsonpDeserializer<ExperimentsSearchResponse<Object>> _DESERIALIZER = createExperimentsSearchResponseDeserializer(
        new NamedDeserializer<>("org.opensearch.client:Deserializer:search_relevance.experiments_search.TDocument")
    );

    protected static <TDocument> void setupExperimentsSearchResponseDeserializer(
        ObjectDeserializer<ExperimentsSearchResponse.Builder<TDocument>> op,
        JsonpDeserializer<TDocument> tDocumentDeserializer
    ) {
    ...
    public boolean equals(Object o) {
        ...
        ExperimentsSearchResponse<?> other = (ExperimentsSearchResponse<?>) o;
