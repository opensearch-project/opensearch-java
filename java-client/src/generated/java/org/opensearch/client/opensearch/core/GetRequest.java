...
public final class GetRequest extends RequestBase implements ToCopyableBuilder<GetRequest.Builder, GetRequest> {
    ...
    public static GetRequest of(Function<GetRequest.Builder, ObjectBuilder<GetRequest>> fn) {
    ...
    /**
     * If <code>true</code>, OpenSearch refreshes the affected shards to make this operation visible to search. If <code>false</code>, do
    ...
    /**
     * List of stored fields to return as part of a hit. If no fields are specified, no stored fields are included in the response. If this
     * field is specified, the <code>_source</code> parameter defaults to false.
     * <p>
    ...
    /**
     * The specific version type: <code>internal</code>, <code>external</code>, <code>external_gte</code>.
     * <p>
     ...
     */
    public static class Builder extends RequestBase.AbstractBuilder<Builder> implements CopyableBuilder<Builder, GetRequest> {
        private String id;
        ...
        /**
         * If <code>true</code>, OpenSearch refreshes the affected shards to make this operation visible to search. If <code>false</code>,
        ...
        /**
         * List of stored fields to return as part of a hit. If no fields are specified, no stored fields are included in the response. If
         * this field is specified, the <code>_source</code> parameter defaults to false.
         * <p>
         * API name: {@code stored_fields}
         * </p>
         *
