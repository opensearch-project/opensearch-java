...
public class RefreshResponse extends ShardsOperationResponseBase implements ToCopyableBuilder<RefreshResponse.Builder, RefreshResponse> {
    ...
    public static RefreshResponse of(Function<RefreshResponse.Builder, ObjectBuilder<RefreshResponse>> fn) {
    ...
    public static class Builder extends ShardsOperationResponseBase.AbstractBuilder<Builder>
        implements
            CopyableBuilder<Builder, RefreshResponse> {

        public Builder() {}

        private Builder(RefreshResponse o) {
            super(o);
        }
