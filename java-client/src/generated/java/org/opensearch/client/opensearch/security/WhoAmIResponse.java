...
// typedef: security.who_am_i.Response

@JsonpDeserializable
@Generated("org.opensearch.client.codegen.CodeGenerator")
public class WhoAmIResponse implements PlainJsonSerializable, ToCopyableBuilder<WhoAmIResponse.Builder, WhoAmIResponse> {
    ...
    public static WhoAmIResponse of(Function<WhoAmIResponse.Builder, ObjectBuilder<WhoAmIResponse>> fn) {
    ...
    /**
     * Builder for {@link WhoAmIResponse}.
     */
    public static class Builder extends ObjectBuilderBase implements CopyableBuilder<Builder, WhoAmIResponse> {
        @Nullable
        private String dn;
        @Nullable
        ...
        private Builder(WhoAmIResponse o) {
            this.dn = o.dn;
    ...
    /**
     * Json deserializer for {@link WhoAmIResponse}
     */
    public static final JsonpDeserializer<WhoAmIResponse> _DESERIALIZER = ObjectBuilderDeserializer.lazy(
        Builder::new,
        WhoAmIResponse::setupWhoAmIResponseDeserializer
    );

    protected static void setupWhoAmIResponseDeserializer(ObjectDeserializer<WhoAmIResponse.Builder> op) {
    ...
    public boolean equals(Object o) {
        ...
        WhoAmIResponse other = (WhoAmIResponse) o;
