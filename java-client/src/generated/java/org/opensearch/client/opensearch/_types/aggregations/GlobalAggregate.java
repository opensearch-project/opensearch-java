...
public class GlobalAggregate extends SingleBucketAggregateBase implements ToCopyableBuilder<GlobalAggregate.Builder, GlobalAggregate> {
    ...
    public static GlobalAggregate of(Function<GlobalAggregate.Builder, ObjectBuilder<GlobalAggregate>> fn) {
    ...
    public static class Builder extends SingleBucketAggregateBase.AbstractBuilder<Builder>
        implements
            CopyableBuilder<Builder, GlobalAggregate> {

        public Builder() {}

        private Builder(GlobalAggregate o) {
            super(o);
        }
