...
public class PutExperimentsResponse
    ...
    /**
     * Singleton instance for {@link PutExperimentsResponse}.
     */
    public static final PutExperimentsResponse _INSTANCE = builder().build();

    public static final JsonpDeserializer<PutExperimentsResponse> _DESERIALIZER = JsonpDeserializer.emptyObject(
        PutExperimentsResponse._INSTANCE
    );
