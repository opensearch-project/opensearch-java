...
public class OpenSearchMlAsyncClient extends ApiClient<OpenSearchTransport, OpenSearchMlAsyncClient> {
    ...
    // ----- Endpoint: ml.execute_algorithm

    /**
     * Execute an algorithm.
     */
    public CompletableFuture<ExecuteAlgorithmResponse> executeAlgorithm(ExecuteAlgorithmRequest request) throws IOException,
        OpenSearchException {
        return this.transport.performRequestAsync(request, ExecuteAlgorithmRequest._ENDPOINT, this.transportOptions);
    }

    /**
     * Execute an algorithm.
     *
     * @param fn a function that initializes a builder to create the {@link ExecuteAlgorithmRequest}
     */
    public final CompletableFuture<ExecuteAlgorithmResponse> executeAlgorithm(
        Function<ExecuteAlgorithmRequest.Builder, ObjectBuilder<ExecuteAlgorithmRequest>> fn
    ) throws IOException, OpenSearchException {
        return executeAlgorithm(fn.apply(new ExecuteAlgorithmRequest.Builder()).build());
    }
