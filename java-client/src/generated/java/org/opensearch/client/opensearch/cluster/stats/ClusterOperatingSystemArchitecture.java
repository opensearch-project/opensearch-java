...
public class ClusterOperatingSystemArchitecture
    implements
        ...
        ToCopyableBuilder<ClusterOperatingSystemArchitecture.Builder, ClusterOperatingSystemArchitecture> {
     ...
     */
    public static class Builder extends ObjectBuilderBase implements CopyableBuilder<Builder, ClusterOperatingSystemArchitecture> {
        private String arch;
        private Integer count;

        public Builder() {}

        private Builder(ClusterOperatingSystemArchitecture o) {
            this.arch = o.arch;
            this.count = o.count;
        }
    ...
    public boolean equals(Object o) {
        ...
        ClusterOperatingSystemArchitecture other = (ClusterOperatingSystemArchitecture) o;
        return this.arch.equals(other.arch) && this.count == other.count;
    }
}
