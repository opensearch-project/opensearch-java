...
// typedef: knn.stats.Request

/**
 * Provides information about the current status of the k-NN plugin.
 */
@Generated("org.opensearch.client.codegen.CodeGenerator")
public final class KnnStatsRequest extends RequestBase implements ToCopyableBuilder<KnnStatsRequest.Builder, KnnStatsRequest> {

    @Nonnull
    private final List<String> nodeId;

    @Nonnull
    private final List<KnnStatName> stat;
    ...
    private KnnStatsRequest(Builder builder) {
        super(builder);
     ...
     */
    @Nonnull
    public final List<KnnStatName> stat() {
        return this.stat;
    }
    ...
    /**
     * Builder for {@link KnnStatsRequest}.
     */
    public static class Builder extends RequestBase.AbstractBuilder<Builder> implements CopyableBuilder<Builder, KnnStatsRequest> {
        @Nullable
        private List<String> nodeId;
        @Nullable
        private List<KnnStatName> stat;
        @Nullable
        private Time timeout;

        public Builder() {}

        private Builder(KnnStatsRequest o) {
            super(o);
         ...
         */
        @Nonnull
        public final Builder stat(List<KnnStatName> list) {
         ...
         */
        @Nonnull
        public final Builder stat(KnnStatName value, KnnStatName... values) {
        ...
        /**
         * Builds a {@link KnnStatsRequest}.
         *
         * @throws NullPointerException if some of the required fields are null.
         */
        @Override
        @Nonnull
        public KnnStatsRequest build() {
            _checkSingleUse();

            return new KnnStatsRequest(this);
        }
    }
    ...
    /**
     * Endpoint "{@code knn.stats}".
     */
    public static final Endpoint<KnnStatsRequest, KnnStatsResponse, ErrorResponse> _ENDPOINT = new SimpleEndpoint<>(
        // Request method
        request -> "GET",
        // Request path
        request -> {
            ...
            if (propsSet == (_stat)) {
                StringBuilder buf = new StringBuilder();
                buf.append("/_plugins/_knn/stats/");
                SimpleEndpoint.pathEncode(request.stat.stream().map(v -> v.jsonValue()).collect(Collectors.joining(",")), buf);
                return buf.toString();
            }
        ...
        false,
        KnnStatsResponse._DESERIALIZER
    );
    ...
    public boolean equals(Object o) {
        ...
        KnnStatsRequest other = (KnnStatsRequest) o;
