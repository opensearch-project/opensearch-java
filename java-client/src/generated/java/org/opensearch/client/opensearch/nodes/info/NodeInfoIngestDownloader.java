...
public class NodeInfoIngestDownloader
    implements
        ...
        ToCopyableBuilder<NodeInfoIngestDownloader.Builder, NodeInfoIngestDownloader> {
     ...
     */
    public static class Builder extends ObjectBuilderBase implements CopyableBuilder<Builder, NodeInfoIngestDownloader> {
        private String enabled;

        public Builder() {}

        private Builder(NodeInfoIngestDownloader o) {
    ...
    public boolean equals(Object o) {
        ...
        NodeInfoIngestDownloader other = (NodeInfoIngestDownloader) o;
