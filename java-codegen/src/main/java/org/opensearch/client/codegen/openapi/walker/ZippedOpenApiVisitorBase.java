...
public abstract class ZippedOpenApiVisitorBase implements ZippedOpenApiVisitor {
    @Override
    public void visitSchemaStart(@Nullable OpenApiSchema left, @Nullable OpenApiSchema right) {
